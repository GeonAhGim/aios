...
갱신 2026-09-10T08:25:00+00:00 · 총 30 · done 30 · inflight 0 · untouched 0 · hold 0 · 재오픈 4 · 깊이(done) {'D0': 1, 'D2': 1, 'D3': 18, 'D?': 10}
...
| L4-7 | core/db/conditional_write.py에 extra_conditions 추가(기본값 없음, 기존 테스트 무변경), | done | 2753,2754,2763 |  | D3 | 092f0c6a |
...
| L4-26 | application/order_query.py, 라우터는 별도 L4(API 명세) — 여기서는 서비스 함수까지 | done | 1602,2767 |  | D3 | 13150db6 |
...
| L4-30 | tests/e2e/bitget_demo/(키 확보 후), 프로파일 verified 갱신, 이 문서 §10 갱신 | done | 2179,2795 |  |  | 6536c34c |
