...
갱신 2026-09-24T17:13:11+00:00 · 총 30 · done 30 · inflight 0 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D0': 1, 'D2': 2, 'D3': 19, 'D?': 8}
...
| L4-9 | application/submit_order.py, order_service/submit.py 축소, order_service | done | 2754,2765,3126 |  | D3 | 60ba097f |
| L4-10 | [FROZEN_PAPER_ONLY, PM 승인] core/executor/executor.py client id 교체 + st | done | 2351,2806,4165 |  |  | 52bb5975 |
...
| L4-18 | application/restart_recovery.py, execution_loop/recovery_wiring.py 연결, | done | 2151,2310,2673 |  | D3 | 89f4fb70 |
...
| L4-22 | exchanges/paper/{fill_model,fee_model,latency_model,venue_profile}.py, | done | 1605,2623,2758 |  | D2 | 6fe3669d |
...
| L4-26 | application/order_query.py, 라우터는 별도 L4(API 명세) — 여기서는 서비스 함수까지 | done | 3542,4923,4932 |  | D3 | 5889943e |
| L4-27 | 관측성: 메트릭 헬퍼 호출 삽입(§7.2 전부), 로그 필드(§7.3), tests/unit/oms/test_metrics_n | done | 3496,4043,4044 |  | D3 | 80176a75 |
...
| L4-30 | tests/e2e/bitget_demo/(키 확보 후), 프로파일 verified 갱신, 이 문서 §10 갱신 | done | 2795,4196,6039 |  | D3 | 9546feac |
