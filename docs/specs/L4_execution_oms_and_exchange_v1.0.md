...
갱신 2026-09-15T17:30:22+00:00 · 총 30 · done 30 · inflight 0 · untouched 0 · hold 0 · 재오픈 4 · 깊이(done) {'D0': 1, 'D2': 1, 'D3': 19, 'D?': 9}
...
| L4-26 | application/order_query.py, 라우터는 별도 L4(API 명세) — 여기서는 서비스 함수까지 | done | 1602,2767,3542 |  | D3 | 48db481 |
