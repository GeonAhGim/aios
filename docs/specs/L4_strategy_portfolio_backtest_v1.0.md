...
갱신 2026-09-24T17:13:11+00:00 · 총 46 · done 46 · inflight 0 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 17, 'D?': 29}
...
| L23 | 마이그레이션 M2 + src/services/execution_loop/portfolio_state.py | done | 3353 |  | D2 | 201b92e1 |
| L24 | src/services/execution_loop/tick.py | done | 3354 |  |  | 3be2e518 |
| L25 | src/foundation/backtest/domain/models.py, snapshot.py, events.py | done | 2462,3210,6385 |  | D2 | 3275bebe |
...
| L32 | 마이그레이션 M4 + adapters/postgres_snapshot_repository.py | done | 6415,6452,6453 |  |  | 3275bebe |
| L33 | src/foundation/backtest/domain/splits.py, param_stability.py | done | 3202,5220,5239 |  |  |  |
...
| L37 | 마이그레이션 M3 + domain/models.py, contracts/v1.py, ports/repository.py, ad | done | 3358 |  | D2 | 301b3789 |
| L38 | checks/context.py, checks/point_in_time.py, checks/backtest.py | done | 3359 |  |  | dab7b189 |
| L39 | checks/oos_walk_forward.py, checks/robustness.py | done | 3360,5212 |  |  |  |
| L40 | checks/stress_capacity.py, checks/failure_conditions.py | done | 3361 |  | D2 | bd26b05d |
| L41 | application/compile_artifact.py, application/run_check.py | done | 5228,5246,5247 |  |  |  |
| L42 | application/start_validation.py(축소), domain/rules.py(evaluate_bundle) | done | 3363,5213 |  |  |  |
...
| L50 | 관측성 배선(각 컨텍스트 로그 필드·메트릭 카운터) + tests/benchmarks/test_backtest_throughp | done | 3367,4216,5214 |  |  |  |
<!-- spec-status:end -->
