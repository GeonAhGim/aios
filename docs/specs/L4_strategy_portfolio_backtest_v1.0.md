...
갱신 2026-09-20T01:29:40+00:00 · 총 46 · done 42 · inflight 4 · untouched 0 · hold 0 · 재오픈 15 · 깊이(done) {'D2': 14, 'D?': 28}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| L01 | src/core/indicators/spec.py, specs_talib.py | done | 3198,3200,4870 |  |  | 63b3db3b |
| L02 | src/core/indicators/registry.py | done | 3200,3216,4870 | 4203 |  | 63b3db3b |
| L03 | src/core/indicators/talib_adapter.py | done | 1505,3200,4870 |  |  | 63b3db3b |
| L06 | src/core/strategy/indicator_key.py | done | 3207,3214,4168 | 4205 | D2 | ca220313 |
| L07 | src/core/indicators/lookback.py | done | 2520,3211,3214 | 4206 | D2 | 6b3f84d4 |
| L08 | src/core/strategy/state_memory.py, market_state.py | done | 3209,3214,4171 |  | D2 | 6845cac7 |
| L10 | src/core/strategy/confidence.py, risk_params.py | done | 3347 |  |  | f5da3d01 |
| L12 | src/core/strategy/engine.py | done | 3348 | 4207 |  | cc0a03fe |
| L13 | 마이그레이션 M1 + src/services/execution_loop/strategy_state_store.py | inflight |  | 3349 |  |  |
| L14 | src/services/execution_loop/market_state.py | done | 2520,3214 |  | D2 | 6b3f84d4 |
| L15 | src/services/condition_compiler.py, preview_service.py | done | 3350 | 4175 |  | 548fef22 |
| L16 | src/services/strategy_builder_service.py | done | 3351 | 4208 |  | a280ed4c |
| L17 | src/core/portfolio/models.py, config.py, state_input.py | done | 3217,3218,3219 |  | D2 | a4c24bd7 |
| L18 | src/core/portfolio/aggregation.py | done | 3217,3218,3219 | 4209 | D2 | a4c24bd7 |
| L19 | src/core/portfolio/sizing/.py (5) | done | 2525,3218 | 4456,4457 | D2 | 0ad58df9 |
| L20 | src/core/portfolio/mandate_binding.py | done | 2603,3219,3368 | 4210,4458,4459 | D2 | a4c24bd7 |
| L21 | src/core/portfolio/accounting.py, rebalance.py | done | 2522,3217 |  |  | b4897f06 |
| L22 | src/core/portfolio/engine.py | done | 3352 | 4211 |  | 4d791990 |
| L23 | 마이그레이션 M2 + src/services/execution_loop/portfolio_state.py | inflight |  | 3353 |  |  |
| L24 | src/services/execution_loop/tick.py | done | 3354 |  |  | 3be2e518 |
| L25 | src/foundation/backtest/domain/models.py, snapshot.py, events.py | done | 2462,3210 |  | D2 | cb037de1 |
| L26 | src/foundation/backtest/ports/.py (3), adapters/list_bars.py | done | 2415,3205 |  |  | 7b77c2e9 |
| L27 | src/foundation/backtest/adapters/bar_fill_simulator.py, application/si | done | 2469,3212 |  | D2 | 36ce16ed |
| L28 | src/core/indicators/series_cache.py | done | 2385,3201 | 4212 |  | 27d69b67 |
| L29 | src/foundation/backtest/domain/universe.py, rules.py | done | 2416,3206 |  |  | b640d658 |
| L30 | src/foundation/backtest/application/event_loop.py | done | 3355 | 4213 | D2 | 23c5fa09 |
| L31 | src/foundation/backtest/application/run_backtest.py, compute_metrics.p | done | 3356 |  | D2 | 93991583 |
| L32 | 마이그레이션 M4 + adapters/postgres_snapshot_repository.py | done | 3357 |  |  |  |
| L33 | src/foundation/backtest/domain/splits.py, param_stability.py | done | 2386,3202 |  |  | 39b74000 |
| L34 | src/foundation/backtest/domain/overfitting.py | done | 2410,3203 | 4214 |  | 5debefbc |
| L35 | src/foundation/backtest/application/param_sweep.py, walk_forward.py, s | done | 2411,3204,4167 |  |  | 9b8dec8f |
| L36 | src/foundation/validation/application/start_validation.py 수정 — hard_fa | done | 2521,3216 |  | D2 | 9d54b295 |
| L37 | 마이그레이션 M3 + domain/models.py, contracts/v1.py, ports/repository.py, ad | inflight |  | 3358 |  |  |
| L38 | checks/context.py, checks/point_in_time.py, checks/backtest.py | done | 3359 |  |  | dab7b189 |
| L39 | checks/oos_walk_forward.py, checks/robustness.py | done | 3360 |  |  | 02e017ff |
| L40 | checks/stress_capacity.py, checks/failure_conditions.py | done | 3361 |  | D2 | bd26b05d |
| L41 | application/compile_artifact.py, application/run_check.py | done | 4038,4040,4041 | 4039 |  | 09c8347b |
| L42 | application/start_validation.py(축소), domain/rules.py(evaluate_bundle) | done | 3363 |  |  | bf0a088e |
| L43 | application/build_bundle.py, projections.py, 라우터 | done | 2412 |  |  | 717f8055 |
| L44 | tests/foundation/integration/validation/test_reproducibility.py + 픽스처 | inflight |  | 3364 |  |  |
| L45 | src/foundation/performance/contracts/v1.py, domain/models.py, methodol | done | 102,3196 |  |  | 0d31e4d |
| L46 | domain/twr.py, mwr.py, identity.py, risk_metrics.py, rules.py | done | 3365,4869 |  |  | c65f3971 |
| L47 | 마이그레이션 M5 + ports/repository.py, adapters/postgres_repository.py | done | 3366 |  |  |  |
| L48 | adapters/paper_input_adapter.py | done | 113,3197 |  |  | f8c5840f |
| L49 | application/compute_statement.py, correct_statement.py, get_statement. | done | 113,3196,3197 |  |  | f8c5840f |
| L50 | 관측성 배선(각 컨텍스트 로그 필드·메트릭 카운터) + tests/benchmarks/test_backtest_throughp | done | 3367 | 4216 |  | c1465719 |
<!-- spec-status:end -->
