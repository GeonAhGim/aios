...
갱신 2026-09-15T17:30:22+00:00 · 총 46 · done 25 · inflight 21 · untouched 0 · hold 0 · 재오픈 24 · 깊이(done) {'D2': 4, 'D?': 21}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| L01 | src/core/indicators/spec.py, specs_talib.py | done | 1367,1401,1505 | 3198,3200 |  | e7b99b1 |
| L02 | src/core/indicators/registry.py | done | 1401,1505,2521 | 3199,3200,3216 |  | b137cfb0 |
| L03 | src/core/indicators/talib_adapter.py | done | 1367,1505 | 3200 |  | e7b99b1 |
| L06 | src/core/strategy/indicator_key.py | done | 2451,2520 | 3207,3214 | D2 | ed575aa9 |
| L07 | src/core/indicators/lookback.py | done | 2468,2520 | 3211,3214 | D2 | ed575aa9 |
| L08 | src/core/strategy/state_memory.py, market_state.py | done | 2456,2520 | 3209,3214 | D2 | ed575aa9 |
| L10 | src/core/strategy/confidence.py, risk_params.py | inflight |  | 3347 |  |  |
| L12 | src/core/strategy/engine.py | inflight |  | 3348 |  |  |
| L13 | 마이그레이션 M1 + src/services/execution_loop/strategy_state_store.py | inflight |  | 3349 |  |  |
| L14 | src/services/execution_loop/market_state.py | done | 2520 | 3214 | D2 | ed575aa9 |
| L15 | src/services/condition_compiler.py, preview_service.py | inflight |  | 3350 |  |  |
| L16 | src/services/strategy_builder_service.py | inflight |  | 3351 |  |  |
| L17 | src/core/portfolio/models.py, config.py, state_input.py | done | 2522,2525,2532 | 3217,3218,3219 |  | 4614899c |
| L18 | src/core/portfolio/aggregation.py | done | 2522,2525,2532 | 3217,3218,3219 |  | 4614899c |
| L19 | src/core/portfolio/sizing/.py (5) | done | 2525 | 3218 |  | a41471a6 |
| L20 | src/core/portfolio/mandate_binding.py | done | 2532,2603,3368 | 3219 |  | 84544f21 |
| L21 | src/core/portfolio/accounting.py, rebalance.py | done | 2522 | 3217 |  | f3faf8f3 |
| L22 | src/core/portfolio/engine.py | inflight |  | 3352 |  |  |
| L23 | 마이그레이션 M2 + src/services/execution_loop/portfolio_state.py | inflight |  | 3353 |  |  |
| L24 | src/services/execution_loop/tick.py | inflight |  | 3354 |  |  |
| L25 | src/foundation/backtest/domain/models.py, snapshot.py, events.py | done | 2462 | 3210 |  | e17cac37 |
| L26 | src/foundation/backtest/ports/.py (3), adapters/list_bars.py | done | 2415 | 3205 |  | a72cdca4 |
| L27 | src/foundation/backtest/adapters/bar_fill_simulator.py, application/si | done | 2469 | 3212 |  | cf0a5475 |
| L28 | src/core/indicators/series_cache.py | done | 2385 | 3201 |  | c84317ef |
| L29 | src/foundation/backtest/domain/universe.py, rules.py | done | 2416 | 3206 |  | d34569da |
| L30 | src/foundation/backtest/application/event_loop.py | inflight |  | 3355 |  |  |
| L31 | src/foundation/backtest/application/run_backtest.py, compute_metrics.p | inflight |  | 3356 |  |  |
...
| L35 | src/foundation/backtest/application/param_sweep.py, walk_forward.py, s | done | 2411 | 3204 |  | 13d400f8 |
| L36 | src/foundation/validation/application/start_validation.py 수정 — hard_fa | done | 2521 | 3216 |  | b137cfb0 |
| L37 | 마이그레이션 M3 + domain/models.py, contracts/v1.py, ports/repository.py, ad | inflight |  | 3358 |  |  |
| L38 | checks/context.py, checks/point_in_time.py, checks/backtest.py | inflight |  | 3359 |  |  |
| L39 | checks/oos_walk_forward.py, checks/robustness.py | inflight |  | 3360 |  |  |
| L40 | checks/stress_capacity.py, checks/failure_conditions.py | inflight |  | 3361 |  |  |
| L41 | application/compile_artifact.py, application/run_check.py | inflight |  | 3362 |  |  |
| L42 | application/start_validation.py(축소), domain/rules.py(evaluate_bundle) | inflight |  | 3363 |  |  |
...
| L45 | src/foundation/performance/contracts/v1.py, domain/models.py, methodol | done | 102 | 3196 |  | f6096a5 |
| L46 | domain/twr.py, mwr.py, identity.py, risk_metrics.py, rules.py | inflight |  | 3365 |  |  |
| L47 | 마이그레이션 M5 + ports/repository.py, adapters/postgres_repository.py | inflight |  | 3366 |  |  |
| L48 | adapters/paper_input_adapter.py | done | 113 | 3197 |  | 0492daa |
| L49 | application/compute_statement.py, correct_statement.py, get_statement. | done | 102,113 | 3196,3197 |  | 0492daa |
| L50 | 관측성 배선(각 컨텍스트 로그 필드·메트릭 카운터) + tests/benchmarks/test_backtest_throughp | inflight |  | 3367 |  |  |
<!-- spec-status:end -->
