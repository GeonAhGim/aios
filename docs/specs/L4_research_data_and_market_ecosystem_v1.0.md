...
갱신 2026-09-17T17:31:56+00:00 · 총 18 · done 16 · inflight 2 · untouched 0 · hold 0 · 재오픈 3 · 깊이(done) {'D2': 3, 'D3': 2, 'D?': 11}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| RD-1 | docs/design/RESEARCH_DATA_SOURCE_EVAL.md — 계층 A 8개 소스의 이용약관·라이선스 원문 인용 | done | 2401,2904,3628 | 4201 | D2 | ab2b7d8 |
...
| RD-5 | domain/entity_link.py + application/link_entities.py + test | done | 2455,2906,4169 | 4170 | D3 | 67a83794 |
| RD-6 | application/{ingest_job,backfill_job}.py + 통합 | done | 2707 |  |  |  |
| RD-7 | application/query.py + as_of PIT 필터 + 적대적 테스트 | done | 2708 | 4172 |  | 23e8f786 |
| RD-8 | entitlement 연동(DC-9) + src/api/routers/research_data.py + 통합 | inflight |  | 2709 |  |  |
| RD-9 | 백테스트·DSL 연결: research. 조회를 스크립트에 노출하되 as_of 자동 바인딩 + 누수 테스트 | inflight |  | 2710,4075 |  |  |
...
| RD-12 | adapters/sources/krx_data.py + test | done | 2713,4188 |  |  | 0c0cd47c |
