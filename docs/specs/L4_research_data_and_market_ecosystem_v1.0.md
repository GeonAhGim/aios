...
갱신 2026-09-15T10:18:54+00:00 · 총 18 · done 5 · inflight 13 · untouched 0 · hold 0 · 재오픈 4 · 깊이(done) {'D?': 5}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| RD-1 | docs/design/RESEARCH_DATA_SOURCE_EVAL.md — 계층 A 8개 소스의 이용약관·라이선스 원문 인용 | done | 2401,2904 | 3628 |  | c991e7a1 |
| RD-2 | contracts/v1.py + domain/known_at.py(FA-9 core/bitemporal.py에 위임 — kno | done | 2402,2427,2907 | 2905,3028 |  | 91f416c1 |
| RD-3 | domain/redistribution.py + domain/revision.py + test | done | 2427,2907 |  |  | 91f416c1 |
| RD-4 | 마이그레이션(research_items WORM·research_sources·매핑 테이블) + adapters/postgre | done | 2463 | 2908 |  | 3b5a6e82 |
| RD-5 | domain/entity_link.py + application/link_entities.py + test | done | 2455 | 2906 |  | 47b02706 |
...
| RD-17 | 프론트 ResearchPage.tsx(검색·소스 상태·종목 연결 표시) | inflight |  | 2718 |  |  |
