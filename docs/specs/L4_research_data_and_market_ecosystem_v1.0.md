...
갱신 2026-09-23T10:54:44+00:00 · 총 18 · done 18 · inflight 0 · untouched 0 · hold 0 · 재오픈 1 · 깊이(done) {'D2': 6, 'D3': 3, 'D?': 9}
...
| RD-4 | 마이그레이션(research_items WORM·research_sources·매핑 테이블) + adapters/postgre | done | 2463,2908 | 5860 | D2 | 87c6c668 |
| RD-5 | domain/entity_link.py + application/link_entities.py + test | done | 2906,4169,4170 |  | D3 | 20f53d00 |
| RD-6 | application/{ingest_job,backfill_job}.py + 통합 | done | 2707 |  |  |  |
| RD-7 | application/query.py + as_of PIT 필터 + 적대적 테스트 | done | 2708,4172 |  | D2 | 2c242af |
| RD-8 | entitlement 연동(DC-9) + src/api/routers/research_data.py + 통합 | done | 2709 |  | D3 | 9359c634 |
...
| RD-17 | 프론트 ResearchPage.tsx(검색·소스 상태·종목 연결 표시) | done | 2718 |  | D2 | 7dfa7b2b |
