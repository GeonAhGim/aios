...
갱신 2026-09-23T17:02:31+00:00 · 총 18 · done 18 · inflight 0 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 6, 'D3': 3, 'D?': 9}
...
| RD-9 | domain/as_of_binding.py(bind_as_of — bar_ts 자동 바인딩·미래 참조 거부) + adapter | done | 2710,4075,5209 |  |  | 2e1c498c |
| RD-10 | adapters/sources/opendart.py + 계약 테스트(픽스처) | done | 2711 |  |  |  |
| RD-11 | adapters/sources/{ecos,kosis}.py + domain/macro_series.py + test | done | 2712 |  |  |  |
| RD-12 | adapters/sources/krx_data.py + test | done | 2713,4188 |  | D2 | 0c0cd47c |
| RD-13 | adapters/sources/fred.py + test | done | 2714 |  |  |  |
| RD-14 | adapters/sources/sec_edgar.py + test | done | 2715 |  |  |  |
| RD-15 | adapters/sources/{gdelt,rss_generic}.py + test | done | 2716 |  |  |  |
| RD-16 | MCP research_data_search 도구(얇은 프록시) + 적대적 테스트 | done | 2717 |  |  |  |
| RD-17 | 프론트 ResearchPage.tsx(검색·소스 상태·종목 연결 표시) | done | 2718,5921,5997 |  | D2 | 7dfa7b2b |
| RD-18 | 커버리지·신선도 대시보드 패널 + 알림(수집 지연·소스 장애) | done | 2719 |  |  |  |
<!-- spec-status:end -->
