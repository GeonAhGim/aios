...
갱신 2026-09-10T08:26:42+00:00 · 총 18 · done 5 · inflight 13 · untouched 0 · hold 0 · 재오픈 5 · 깊이(done) {'D?': 5}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| RD-1 | docs/design/RESEARCH_DATA_SOURCE_EVAL.md — 계층 A 8개 소스의 이용약관·라이선스 원문 인용 | done | 2401 | 2904 |  | e1c03575 |
| RD-2 | contracts/v1.py + domain/known_at.py(FA-9 core/bitemporal.py에 위임 — kno | done | 2402,2427 | 2905,2907,3028 |  | 66961cec |
| RD-3 | domain/redistribution.py + domain/revision.py + test | done | 2427 | 2907 |  | 66961cec |
