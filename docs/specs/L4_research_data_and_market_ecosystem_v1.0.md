...
갱신 2026-09-22T17:04:05+00:00 · 총 18 · done 18 · inflight 0 · untouched 0 · hold 0 · 재오픈 1 · 깊이(done) {'D2': 5, 'D3': 2, 'D?': 11}
...
| RD-4 | 마이그레이션(research_items WORM·research_sources·매핑 테이블) + adapters/postgre | done | 2463,2908 |  |  | 87c6c668 |
...
| RD-8 | entitlement 연동(DC-9) + src/api/routers/research_data.py + 통합 | done | 2709 |  |  | 9359c634 |
| RD-9 | 백테스트·DSL 연결: research. 조회를 스크립트에 노출하되 as_of 자동 바인딩 + 누수 테스트 | done | 2710 | 4075,5209 |  | d1898d54 |
