...
갱신 2026-09-12T17:04:32+00:00 · 총 18 · done 5 · inflight 13 · untouched 0 · hold 0 · 재오픈 4 · 깊이(done) {'D?': 5}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| RD-1 | docs/design/RESEARCH_DATA_SOURCE_EVAL.md — 계층 A 8개 소스의 이용약관·라이선스 원문 인용 | done | 2401,2904 |  |  | c991e7a1 |
