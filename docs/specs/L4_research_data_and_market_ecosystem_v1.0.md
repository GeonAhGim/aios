...
갱신 2026-09-16T17:30:45+00:00 · 총 18 · done 6 · inflight 12 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 2, 'D3': 2, 'D?': 2}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| RD-1 | docs/design/RESEARCH_DATA_SOURCE_EVAL.md — 계층 A 8개 소스의 이용약관·라이선스 원문 인용 | done | 2401,2904,3628 |  | D2 | ab2b7d8 |
...
| RD-5 | domain/entity_link.py + application/link_entities.py + test | done | 2455,2906 |  | D3 | 9a3a7232 |
| RD-6 | application/{ingest_job,backfill_job}.py + 통합 | inflight |  | 2707 |  |  |
| RD-7 | application/query.py + as_of PIT 필터 + 적대적 테스트 | inflight |  | 2708 |  |  |
| RD-8 | entitlement 연동(DC-9) + src/api/routers/research_data.py + 통합 | inflight |  | 2709 |  |  |
| RD-9 | 백테스트·DSL 연결: research. 조회를 스크립트에 노출하되 as_of 자동 바인딩 + 누수 테스트 | inflight |  | 2710 |  |  |
| RD-10 | adapters/sources/opendart.py + 계약 테스트(픽스처) | inflight |  | 2711 |  |  |
| RD-11 | adapters/sources/{ecos,kosis}.py + domain/macro_series.py + test | inflight |  | 2712 |  |  |
| RD-12 | adapters/sources/krx_data.py + test | inflight |  | 2713 |  |  |
| RD-13 | adapters/sources/fred.py + test | inflight |  | 2714 |  |  |
| RD-14 | adapters/sources/sec_edgar.py + test | inflight |  | 2715 |  |  |
| RD-15 | adapters/sources/{gdelt,rss_generic}.py + test | inflight |  | 2716 |  |  |
| RD-16 | MCP research_data_search 도구(얇은 프록시) + 적대적 테스트 | inflight |  | 2717 |  |  |
| RD-17 | 프론트 ResearchPage.tsx(검색·소스 상태·종목 연결 표시) | done | 2718 |  |  | 7dfa7b2b |
| RD-18 | 커버리지·신선도 대시보드 패널 + 알림(수집 지연·소스 장애) | inflight |  | 2719 |  |  |
<!-- spec-status:end -->
