...
갱신 2026-09-24T17:13:11+00:00 · 총 18 · done 18 · inflight 0 · untouched 0 · hold 0 · 재오픈 1 · 깊이(done) {'D2': 7, 'D3': 3, 'D?': 8}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| RD-1 | docs/design/RESEARCH_DATA_SOURCE_EVAL.md — 계층 A 8개 소스의 이용약관·라이선스 원문 인용 | done | 2904,3628,4201 |  | D2 | e1c03575 |
| RD-2 | contracts/v1.py + domain/known_at.py(FA-9 core/bitemporal.py에 위임 — kno | done | 2905,2907,3028 |  | D3 | 775370f2 |
| RD-3 | domain/redistribution.py + domain/revision.py + test | done | 2427,2907 |  | D2 | 91f416c1 |
| RD-4 | 마이그레이션(research_items WORM·research_sources·매핑 테이블) + adapters/postgre | done | 2463,2908,5860 |  | D2 | 34cdb098 |
| RD-5 | domain/entity_link.py + application/link_entities.py + test | done | 2906,4169,4170 |  | D3 | 20f53d00 |
| RD-6 | application/{ingest_job,backfill_job}.py + 통합 | done | 2707,5918 |  |  | 22eed540 |
| RD-7 | application/query.py + as_of PIT 필터 + 적대적 테스트 | done | 4172,5919,5921 |  | D2 | 7dfa7b2b |
| RD-8 | entitlement 연동(DC-9) + src/api/routers/research_data.py + 통합 | done | 2709,5997 |  | D3 | 7dfa7b2b |
| RD-9 | domain/as_of_binding.py(bind_as_of — bar_ts 자동 바인딩·미래 참조 거부) + adapter | done | 2710,4075,5209 |  | D2 | 2e1c498c |
| RD-10 | adapters/sources/opendart.py + 계약 테스트(픽스처) | done | 6397,6415,6453 |  |  | 78323725 |
| RD-11 | adapters/sources/{ecos,kosis}.py + domain/macro_series.py + test | done | 6379,6400,6446 |  |  | cfb0c6db |
| RD-12 | adapters/sources/krx_data.py + test | done | 2713,4188 |  | D2 | 0c0cd47c |
| RD-13 | adapters/sources/fred.py + test | done | 6380,6401,6447 |  |  | 90b10f16 |
| RD-14 | adapters/sources/sec_edgar.py + test | done | 6381,6402,6448 |  |  | 79d515e8 |
| RD-15 | adapters/sources/{gdelt,rss_generic}.py + test | done | 6382,6403,6449 |  |  | 21bce5c9 |
| RD-16 | MCP research_data_search 도구(얇은 프록시) + 적대적 테스트 | done | 6383,6404,6450 |  |  | f80e3416 |
| RD-17 | 프론트 ResearchPage.tsx(검색·소스 상태·종목 연결 표시) | done | 2718,5921,5997 |  | D2 | 7dfa7b2b |
| RD-18 | 커버리지·신선도 대시보드 패널 + 알림(수집 지연·소스 장애) | done | 6451,6708,6753 | 6707 |  |  |
<!-- spec-status:end -->
