...
갱신 2026-09-15T17:30:22+00:00 · 총 6 · done 6 · inflight 0 · untouched 0 · hold 0 · 재오픈 2 · 깊이(done) {'D2': 1, 'D?': 5}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| EO-1 | domain/{models,rules}.py + 단위 테스트 | done | 1116,1366,2812 | 3629 |  | fd7d5a96 |
| EO-2 | 마이그레이션 + ports/repository.py + adapters/postgres_repository.py + 통합 테스 | done | 1117,1366,2393 |  | D2 | 170bfa45 |
| EO-3 | scheduler.py 시그니처 변경(pre_submit_gate/distrust_monitor/lease_repo 필수화)  | done | 1115,1118,1366 |  |  | e467f72 |
| EO-4 | background_loops.py 조립부 수정(게이트·모니터·리포지토리 주입) + BackgroundLoops.stop()에 | done | 1119,1366 |  |  | e467f72 |
| EO-5 | execution_deps.py/ExecutionService 동등 배선(시그니처 재확인 후) | done | 1120 |  |  | cbb8b9c |
| EO-6 | 정적 검사(I-01 CI 게이트) | done | 1115,2811 | 3629 |  | f129b7ed |
<!-- spec-status:end -->
