...
갱신 2026-09-23T09:20:44+00:00 · 총 6 · done 6 · inflight 0 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 1, 'D?': 5}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| EO-1 | domain/{models,rules}.py + 단위 테스트 | done | 1366,2812,3629 |  |  | 98c99ae4 |
...
| EO-6 | 정적 검사(I-01 CI 게이트) | done | 1115,2811,3629 |  |  | 98c99ae4 |
<!-- spec-status:end -->
