...
갱신 2026-09-10T17:02:14+00:00 · 총 6 · done 6 · inflight 0 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 1, 'D?': 5}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| EO-1 | domain/{models,rules}.py + 단위 테스트 | done | 1116,1366,2812 |  |  | fd7d5a96 |
...
| EO-6 | 정적 검사(I-01 CI 게이트) | done | 1115,2811 |  |  | f129b7ed |
<!-- spec-status:end -->
