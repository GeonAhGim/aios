...
갱신 2026-09-23T17:02:31+00:00 · 총 29 · done 28 · inflight 1 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 2, 'D3': 12, 'D?': 14}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| FA-0a | 소급 정정: tenant_id FK 재지정 — 19개 테이블이 tenant_id UUID REFERENCES users(use | done | 3015,3017,3022 |  |  | 6abe021c |
| FA-0b | 소급 정정: 단일 포트폴리오 전제 제거 — portfolio_mandate UNIQUE (tenant_id)(d8e8e4ba2 | done | 1941,3016 |  |  | f8eeeb0b |
| FA-0c | 키 문법 정정 A: ledger_account.account_code — 현재 "USER:{uuid}:{sub}" | done | 3031,3728,6028 |  | D3 |  |
| FA-0d | 키 문법 정정 B: pos_snapshot.position_key — VARCHAR(200) PRIMARY KEY이며 중앙 생 | done | 3530,4889,4890 |  | D3 | 35229e8d |
...
| FA-10 | 소급 마이그레이션 C: 투영 테이블만(pos_snapshot·ledger_balance·positions) 양시간축 컬럼 +  | done | 3022,3023,3026 |  | D3 | 1d152613 |
...
| FA-18 | db/failover.py(다중 호스트·읽기전용 감지·재연결) + 통합(모의 페일오버) | done | 2675 |  |  |  |
