...
갱신 2026-09-15T17:30:22+00:00 · 총 29 · done 22 · inflight 7 · untouched 0 · hold 0 · 재오픈 20 · 깊이(done) {'D2': 2, 'D3': 11, 'D?': 9}
...
| FA-0c | 키 문법 정정 A: ledger_account.account_code — 현재 "USER:{uuid}:{sub}" | done | 1942 | 3031 | D3 | 4c925cf4 |
| FA-0d | 키 문법 정정 B: pos_snapshot.position_key — VARCHAR(200) PRIMARY KEY이며 중앙 생 | done | 2543,2545,3530 | 3032,3034 | D3 | 97f4da24 |
| FA-1 | entities/contracts/v1.py + domain/hierarchy.py + domain/defaults.py +  | done | 2067,2431,3002 | 3113 | D2 | 37c842cc |
...
| FA-6 | 리스크·성과·API 응답에 펀드/포트폴리오 스코프 반영 + 회귀 | done | 1944 | 2629,3033 | D3 | df84bd55 |
...
| FA-9 | core/bitemporal.py + 4종 질의 + test | done | 2402,2892,3003 | 2905,3028 | D3 | dceb4b2b |
...
| FA-15 | replay.py + scripts/replay_verify.py + 야간 CI 훅 | done | 2394,3581,3591 | 3019 | D3 | cd148b67 |
...
| FA-20 | ops/backup_verify.py(PITR 복구 리허설) + 스케줄 | done | 2677 |  |  | 09b37691 |
