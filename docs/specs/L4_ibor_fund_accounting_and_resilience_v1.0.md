...
갱신 2026-09-24T17:13:11+00:00 · 총 29 · done 28 · inflight 1 · untouched 0 · hold 0 · 재오픈 1 · 깊이(done) {'D2': 2, 'D3': 12, 'D?': 14}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| FA-0a | 소급 정정: tenant_id FK 재지정 — 19개 테이블이 tenant_id UUID REFERENCES users(use | done | 3017,3022,6520 |  |  | 42a9d8da |
| FA-0b | 소급 정정: 단일 포트폴리오 전제 제거 — portfolio_mandate UNIQUE (tenant_id)(d8e8e4ba2 | done | 1941,3016 |  |  | f8eeeb0b |
| FA-0c | 키 문법 정정 A: ledger_account.account_code — 현재 "USER:{uuid}:{sub}" | done | 3728,6028,6186 |  | D3 | 59feda41 |
| FA-0d | 키 문법 정정 B: pos_snapshot.position_key — VARCHAR(200) PRIMARY KEY이며 중앙 생 | done | 4889,4890,6385 |  | D3 | 3275bebe |
| FA-1 | entities/contracts/v1.py + domain/hierarchy.py + domain/defaults.py +  | done | 2431,3002,3113 |  | D2 | 8fc8bf5c |
| FA-2 | 마이그레이션(4테이블) + adapters/postgres_repository.py + 통합. legal_entity.tena | done | 2431,3005,3030 |  |  | aa16920e |
| FA-2a | 소급 교정: 이미 병합된 e6b1d94a7c3f_fa2_entities_hierarchy.py:53의 legal_entity. | done | 1906,3007,3011 |  |  | 2d93a2e0 |
| FA-3 | 소급 마이그레이션 A: orders·fills에 fund_id/portfolio_id NOT NULL + 기본값 백필 + FK | done | 1709,3008 |  |  | 1e6a0db2 |
| FA-4 | 소급 마이그레이션 B: pos_snapshot·pos_journal·pos_account(LB-8)·ledger_journal | done | 3313,3728,6028 |  | D3 |  |
| FA-5 | application/resolve_context.py + 기존 유스케이스 시그니처 확장(주문·포지션·원장 진입점) | done | 1925,3009,3013 |  |  | 7278699f |
| FA-6 | 리스크·성과·API 응답에 펀드/포트폴리오 스코프 반영 + 회귀 | done | 1944,2629,3033 |  | D3 | 81793ac2 |
| FA-7 | allocation/domain/{policy,average_price}.py + test | done | 1708,3006 |  |  | 90152be0 |
| FA-8 | allocation/application/allocate_fills.py + 마이그레이션 + 통합 | done | 3014,3728,6028 |  | D2 |  |
| FA-9 | core/bitemporal.py + 4종 질의 + test | done | 2905,3003,3028 |  | D3 | 775370f2 |
| FA-10 | 소급 마이그레이션 C: 투영 테이블만(pos_snapshot·ledger_balance·positions) 양시간축 컬럼 +  | done | 3023,3026,6385 |  | D3 | 3275bebe |
| FA-11 | ledger/domain/correction.py + positions/domain/restatement.py + test | done | 2058,2059,3024 |  | D3 | 63764b46 |
| FA-12 | application/{ibor_view,abor_snapshot}.py + 통합 | done | 2059,3025 |  | D3 | e4c8d005 |
| FA-13 | core/eventstore/contracts/v1.py + append.py(해시체인·조건부) + test. 감사 2026- | done | 1703,2050,3004 |  |  | f5830714 |
| FA-14 | projections/{orders,positions,ledger}.py — 기존 order_events(OMS)·pos_jo | done | 2173,3018,4153 |  | D3 | 48ec858b |
| FA-15 | replay.py + scripts/replay_verify.py + 야간 CI 훅 | done | 3019,3581,3591 |  | D3 | 1d152613 |
| FA-16 | 기존 쓰기 경로에 이벤트 append 삽입(같은 트랜잭션) + 적대적(이벤트 없는 상태 변경 탐지) | done | 3021,3029,5687 |  | D3 | c844c5ed |
| FA-17 | db/session_policy.py(2초 상한) + 위반 탐지 테스트 | done | 2674,5917 |  |  | b6d8d849 |
| FA-18 | db/failover.py(다중 호스트·읽기전용 감지·재연결) + 통합(모의 페일오버) | done | 6378,6399,6445 | 6706 |  | 29f889a6 |
| FA-19 | 멱등 재시도 전수 점검(모든 쓰기 유스케이스) + 정적 검사 | done | 2676 |  |  | 8f6e423c |
| FA-20 | ops/backup_verify.py(PITR 복구 리허설) + 스케줄 | done | 2677 |  | D3 | 09b37691 |
| FA-21 | docs/ops/DR_RUNBOOK.md + 페일오버 훈련 절차 | done | 2678 |  |  | 9f3944ae |
| FA-22 | core/security/kms_port.py + local_keyring 어댑터 이전 + test | done | 2679,5915 |  |  | 543d7b0d |
| FA-23 | kms_stub 어댑터 + 회전·감사 계약 테스트 | done | 2680,5916 |  |  | 1b4bd7f2 |
