...
갱신 2026-09-23T10:54:44+00:00 · 총 29 · done 28 · inflight 1 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 2, 'D3': 12, 'D?': 14}
...
| FA-0c | 키 문법 정정 A: ledger_account.account_code — 현재 "USER:{uuid}:{sub}" | done | 1942,3031,3728 |  | D3 | 59feda41 |
...
| FA-4 | 소급 마이그레이션 B: pos_snapshot·pos_journal·pos_account(LB-8)·ledger_journal | done | 3010,3313,3728 |  | D3 | cb81387b |
...
| FA-8 | allocation/application/allocate_fills.py + 마이그레이션 + 통합 | done | 3012,3014,3728 |  | D2 |  |
...
| FA-17 | db/session_policy.py(2초 상한) + 위반 탐지 테스트 | done | 2674 |  |  |  |
...
| FA-22 | core/security/kms_port.py + local_keyring 어댑터 이전 + test | done | 2679 |  |  |  |
| FA-23 | kms_stub 어댑터 + 회전·감사 계약 테스트 | done | 2680 |  |  |  |
