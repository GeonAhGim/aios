...
갱신 2026-09-20T01:29:40+00:00 · 총 29 · done 27 · inflight 2 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 2, 'D3': 12, 'D?': 13}
...
| FA-0d | 키 문법 정정 B: pos_snapshot.position_key — VARCHAR(200) PRIMARY KEY이며 중앙 생 | done | 3032,3034,3530 |  | D3 | d800d087 |
...
| FA-16 | 기존 쓰기 경로에 이벤트 append 삽입(같은 트랜잭션) + 적대적(이벤트 없는 상태 변경 탐지) | done | 2432,3021,3029 |  | D3 | 093e1ef7 |
...
| FA-24 | entities/domain/region.py + 저장 위치 정책 + 적대적(타 리전 저장 거부) | done | 2681 |  |  | 651f48b |
<!-- spec-status:end -->
