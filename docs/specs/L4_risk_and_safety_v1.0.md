...
갱신 2026-09-15T10:18:54+00:00 · 총 58 · done 53 · inflight 0 · untouched 0 · hold 5 · 재오픈 2 · 깊이(done) {'D3': 19, 'D?': 34}
...
| R-27 | execution_loop/exposure_snapshot.py + 통합 테스트 | done | 1360,2828,2830 |  |  | aa4cdc35 |
...
| R-35 | application/evaluate_pre_submit.py + test_pre_submit_gate.py | done | 2831,2834,2840 |  |  | cde76759 |
...
| R-43 | metrics_collector.py data_delay 실측 + circuit_breaker.py 조건부 UPDATE + 테 | done | 1363,1568,2832 |  |  | afa23ca6 |
| R-44 | core/safety/recovery_gate.py + 테스트 | done | 2827,2832,2840 |  |  | cde76759 |
| R-45 | services/safety/circuit_breaker_loop.py + main.py 배선(PM) + test_circui | done | 1363,2832 |  |  | afa23ca6 |
| R-46 | 마이그레이션 d6f7b4c3e5a6 + postgres_signal_repository.py + application/intr | done | 2136,2841 |  | D3 | 67310df2 |
| R-47 | services/safety/reference_quotes.py + 어댑터 2종(§10 미확인 표기) + 테스트(fake) | hold |  |  |  |  |
| R-48 | data_distrust.py restore + services/safety/distrust_wiring.py + data_d | done | 103,2810 |  |  | 66c9c630 |
...
| R-53 | application/recovery_gate.py + 라우터 + tests/foundation/integration/risk | done | 2135,2840 | 2425 |  | cde76759 |
| R-54 | application/replay_decision.py + src/tools/risk_replay.py + test_repla | done | 2138,2174,2395 |  | D3 | f31a4842 |
...
| R-58 | docs/RED_TEAM_FINDINGS.md 등재(correlation 0.0 fail-open, data_delay 상수  | done | 1568,2835,2836 |  |  | 2eead0a5 |
<!-- spec-status:end -->
