...
갱신 2026-09-15T17:30:22+00:00 · 총 58 · done 53 · inflight 0 · untouched 0 · hold 5 · 재오픈 3 · 깊이(done) {'D3': 27, 'D?': 26}
...
| R-27 | execution_loop/exposure_snapshot.py + 통합 테스트 | done | 1360,2828,2830 |  | D3 | aa4cdc35 |
...
| R-30 | execution_loop/equity_tracker.py UTC·단조 UPDATE + 테스트(105 §4.2 형태 B) | done | 1360,2822,2830 |  |  | aa4cdc35 |
...
| R-33 | domain/fence.py, application/read_fence.py, repo read_fences + 테스트 | done | 1362,1403,2831 | 2425 |  | 39bef3df |
| R-34 | 마이그레이션 f4b9d6e5a7c8 + contracts/v1.py·domain/models.py 확장 + evaluate_r | done | 1386,2829,2831 |  |  | 39bef3df |
...
| R-39 | services/safety/open_order_sweeper.py + 테스트 | done | 1353,1386,2406 |  | D3 | 30ca7756 |
...
| R-43 | metrics_collector.py data_delay 실측 + circuit_breaker.py 조건부 UPDATE + 테 | done | 1363,1568,2832 |  | D3 | afa23ca6 |
...
| R-46 | 마이그레이션 d6f7b4c3e5a6 + postgres_signal_repository.py + application/intr | done | 2136,2841,3672 |  | D3 | 42a9d8da |
...
| R-53 | application/recovery_gate.py + 라우터 + tests/foundation/integration/risk | done | 2135,2840 | 2425 | D3 | cde76759 |
| R-54 | application/replay_decision.py + src/tools/risk_replay.py + test_repla | done | 2138,2174,2395 | 3658 | D3 | f31a4842 |
...
| R-58 | docs/RED_TEAM_FINDINGS.md 등재(correlation 0.0 fail-open, data_delay 상수  | done | 1568,2835,2836 |  | D3 | 2eead0a5 |
<!-- spec-status:end -->
