...
갱신 2026-09-24T17:13:11+00:00 · 총 58 · done 53 · inflight 0 · untouched 0 · hold 5 · 재오픈 0 · 깊이(done) {'D3': 27, 'D?': 26}
...
| R-32 | execution_loop/tick_risk_phase.py + tick.py 수정 + test_execution_tick.p | done | 6023,6026,6185 |  | D3 | bc2d7da |
| R-33 | domain/fence.py, application/read_fence.py, repo read_fences + 테스트 | done | 5809,5810,5928 |  |  | bc8c555b |
...
| R-37 | 마이그레이션 93c0e7f6b8d9_orders_risk_decision_fk.py + order_service/fenced_ | done | 6181,6205,6206 |  | D3 | 8f74ee05 |
...
| R-46 | 마이그레이션 d6f7b4c3e5a6 + postgres_signal_repository.py + application/intr | done | 3672,3948,6520 |  | D3 | 42a9d8da |
...
| R-49 | core/safety/market_correlation.py + watchdog.py decide 확장 + 테스트 | done | 2838,2843,6391 |  |  | 732b3922 |
| R-50 | core/safety/liquidation_planner.py + test_liquidation_planner.py | done | 2357,2839,2843 |  |  | bb785f79 |
| R-51 | 마이그레이션 e5a8c5d4f6b7 + watchdog_process.py 수정 + test_watchdog_liquidati | done | 2357,2843,6391 |  |  | 732b3922 |
| R-52 | services/safety/liquidation_executor.py + main.py worker 배선(PM) + test | done | 2134,2358,2844 |  |  | 91171b56 |
| R-53 | application/recovery_gate.py + 라우터 + tests/foundation/integration/risk | done | 5809,5810,5928 |  | D3 | bc8c555b |
