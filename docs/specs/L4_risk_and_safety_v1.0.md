...
갱신 2026-09-23T10:49:26+00:00 · 총 58 · done 53 · inflight 0 · untouched 0 · hold 5 · 재오픈 2 · 깊이(done) {'D3': 27, 'D?': 26}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| R-1 | src/core/risk/hashing.py + tests/unit/core/risk/test_hashing.py | hold |  |  |  |  |
| R-2 | src/core/risk/decision.py + tests/unit/contracts/test_risk_decision_sc | done | 1210 |  |  | 17527b7 |
| R-3 | src/core/risk/inputs.py + test_inputs_contract.py | done | 1360,2830 |  |  | aa4cdc35 |
| R-4 | src/core/risk/rules/base.py | done | 2815,2816,2817 |  | D3 | 9d3940c5 |
| R-5 | rules/{daily_loss,max_drawdown,leverage,concentration,strategy_allocat | done | 1193,2815,2816 |  | D3 | 9d3940c5 |
| R-6 | rules/{daily_loss,max_drawdown,leverage,concentration,strategy_allocat | done | 1193,2815,2816 |  | D3 | 9d3940c5 |
| R-7 | rules/{daily_loss,max_drawdown,leverage,concentration,strategy_allocat | done | 1193,2815,2816 |  | D3 | 9d3940c5 |
| R-8 | rules/{daily_loss,max_drawdown,leverage,concentration,strategy_allocat | done | 1193,2815,2816 |  | D3 | 9d3940c5 |
| R-9 | rules/{daily_loss,max_drawdown,leverage,concentration,strategy_allocat | done | 1193,2815,2816 |  | D3 | 9d3940c5 |
| R-10 | rules/{daily_loss,max_drawdown,leverage,concentration,strategy_allocat | done | 1193,2815,2816 |  | D3 | 9d3940c5 |
| R-11 | rules/{daily_loss,max_drawdown,leverage,concentration,strategy_allocat | done | 1193,2815,2816 |  | D3 | 9d3940c5 |
| R-12 | rules/{daily_loss,max_drawdown,leverage,concentration,strategy_allocat | done | 1193,2815,2816 |  | D3 | 9d3940c5 |
| R-13 | rules/{daily_loss,max_drawdown,leverage,concentration,strategy_allocat | done | 1193,2815,2816 |  | D3 | 9d3940c5 |
| R-14 | src/core/risk/limits.py + test_limits.py | done | 1186,1193,2817 |  |  | 8f2b735e |
| R-15 | src/core/risk/policy_bundle.py + test_policy_bundle.py | done | 1196,2814,2819 |  |  | 9c3657ba |
| R-16 | src/core/risk/evaluator.py + test_evaluator.py | done | 1193,1209,2820 |  |  | 4221d1e3 |
| R-17 | src/core/risk/engine.py 축약(facade) + models.py decision_id 옵션 필드 | done | 1209,1361,2820 |  |  | 4221d1e3 |
| R-18 | src/core/risk_stats/{models,returns}.py + 테스트 | hold |  |  |  |  |
| R-19 | risk_stats/var_parametric.py, var_historical.py, var_cornish_fisher.py | hold |  |  |  |  |
| R-20 | risk_stats/correlation_matrix.py, portfolio.py + 테스트 | hold |  |  |  |  |
| R-21 | config/risk_policy.yaml §3.3 확장 + risk_policy_loader.py 모델 + test_risk | done | 2134,2818,2839 |  |  | 615a8156 |
| R-22 | 마이그레이션 a9c4e1f7b2d3_risk_rule_bundle.py + adapters/postgres_bundle_rep | done | 2138,2174,2819 |  | D3 | 9c3657ba |
| R-23 | application/activate_rule_bundle.py + 라우터(/foundation/risk-gate/rule-b | done | 1315,2174 |  |  | fcf98972 |
| R-24 | 마이그레이션 b8d5f2a1c3e4_risk_decision_worm.py + postgres_decision_reposito | done | 1210,1316,2138 |  | D3 | 59f6e5d5 |
| R-25 | src/services/risk_decision_recorder.py + test_risk_decision_recorder.p | done | 2824,2831,2842 |  |  | 22952fa5 |
| R-26 | 마이그레이션 c7e6a3b2d4f5_risk_limit.py + postgres_limit_repository.py + ups | done | 1317 |  |  | ab501dd |
| R-27 | execution_loop/exposure_snapshot.py + 통합 테스트 | done | 2828,2830,4140 |  | D3 | 4936cbdc |
| R-28 | execution_loop/candle_history.py + 테스트 | done | 1360,2821,2830 |  |  | aa4cdc35 |
| R-29 | execution_loop/var_estimator.py 교체 + correlation_service.py 신규 + corre | done | 1568,2825,2830 |  |  | 42017d56 |
| R-30 | execution_loop/equity_tracker.py UTC·단조 UPDATE + 테스트(105 §4.2 형태 B) | done | 2822,2830,4138 |  |  | 5631cddb |
| R-31 | execution_loop/risk_inputs_assembler.py + account_state.py 축약 + 통합 테스트 | done | 1386,2830,3315 |  |  | aa4cdc35 |
| R-32 | execution_loop/tick_risk_phase.py + tick.py 수정 + test_execution_tick.p | done | 3317,3598,3615 |  | D3 |  |
| R-33 | domain/fence.py, application/read_fence.py, repo read_fences + 테스트 | done | 1362,1403,2831 | 5808,5809,5810 |  | 39bef3df |
| R-34 | 마이그레이션 f4b9d6e5a7c8 + contracts/v1.py·domain/models.py 확장 + evaluate_r | done | 2829,2831,4042 |  |  | 71e41617 |
| R-35 | application/evaluate_pre_submit.py + test_pre_submit_gate.py | done | 2831,2834,2840 |  | D3 | cde76759 |
| R-36 | order_service/gate.py·foundation_gate.py·pre_submit_check.py 수정 + test | done | 1806,2834,2837 |  |  | 960a5768 |
| R-37 | 마이그레이션 93c0e7f6b8d9_orders_risk_decision_fk.py + order_service/fenced_ | done | 3392,3598,3615 |  | D3 |  |
| R-38 | services/safety/legacy_execution_pauser.py + 테스트 | done | 1335,1353,2823 |  |  | ad9401cf |
| R-39 | services/safety/open_order_sweeper.py + 테스트 | done | 1386,2406,4139 |  | D3 | c1d9571c |
| R-40 | services/safety/kill_switch_service.py + activate_safety_control.py 훅  | done | 2833,2841,2843 |  | D3 | bb785f79 |
| R-41 | risk_guard_service.py → KillSwitchService 사용 + 테스트 | done | 1370,2833 |  |  | 9a165343 |
| R-42 | core/safety/data_freshness.py 신규 + exchanges/common/instrumented_adapt | done | 1330,1568,2826 |  |  | c4f40a29 |
| R-43 | metrics_collector.py data_delay 실측 + circuit_breaker.py 조건부 UPDATE + 테 | done | 1568,2832,4141 |  | D3 | 87160a5a |
| R-44 | core/safety/recovery_gate.py + 테스트 | done | 2827,2832,2840 |  | D3 | cde76759 |
| R-45 | services/safety/circuit_breaker_loop.py + main.py 배선(PM) + test_circui | done | 1363,2832 |  | D3 | afa23ca6 |
| R-46 | 마이그레이션 d6f7b4c3e5a6 + postgres_signal_repository.py + application/intr | done | 2841,3672,3948 |  | D3 | 42a9d8da |
| R-47 | services/safety/reference_quotes.py + 어댑터 2종(§10 미확인 표기) + 테스트(fake) | hold |  |  |  |  |
| R-48 | data_distrust.py restore + services/safety/distrust_wiring.py + data_d | done | 103,2810 |  | D3 | 66c9c630 |
| R-49 | core/safety/market_correlation.py + watchdog.py decide 확장 + 테스트 | done | 2357,2838,2843 |  |  | bb785f79 |
| R-50 | core/safety/liquidation_planner.py + test_liquidation_planner.py | done | 2357,2839,2843 |  |  | bb785f79 |
| R-51 | 마이그레이션 e5a8c5d4f6b7 + watchdog_process.py 수정 + test_watchdog_liquidati | done | 2134,2357,2843 |  |  | bb785f79 |
| R-52 | services/safety/liquidation_executor.py + main.py worker 배선(PM) + test | done | 2134,2358,2844 |  |  | 91171b56 |
| R-53 | application/recovery_gate.py + 라우터 + tests/foundation/integration/risk | done | 2135,2840 | 5808,5809,5810 | D3 | cde76759 |
| R-54 | application/replay_decision.py + src/tools/risk_replay.py + test_repla | done | 2174,2395,3658 |  | D3 | 64b6f178 |
| R-55 | services/risk_alerting.py + 테스트 | done | 2139,2842 |  |  | 22952fa5 |
| R-56 | tests/adversarial/risk/{test_no_llm_in_risk_path,test_agent_cannot_for | done | 1520,1532,1537 |  | D3 | 636b628 |
| R-57 | tests/performance/test_pre_trade_latency.py + CI 단언 | done | 1550,2323,2835 |  |  | dc44aed2 |
| R-58 | docs/RED_TEAM_FINDINGS.md 등재(correlation 0.0 fail-open, data_delay 상수  | done | 2835,2836,4202 |  | D3 | 2eead0a5 |
<!-- spec-status:end -->
