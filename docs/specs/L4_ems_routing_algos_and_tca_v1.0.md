...
갱신 2026-09-24T17:13:11+00:00 · 총 18 · done 18 · inflight 0 · untouched 0 · hold 0 · 재오픈 2 · 깊이(done) {'D2': 8, 'D3': 2, 'D?': 8}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| EM-1 | contracts/v1.py + 스냅샷 | done | 3117,3125,4998 |  | D2 | ebe531a3 |
| EM-2 | domain/parent_child.py + test — 감사 2026-09-06: 이미 구현된 부분이 있다. orders.p | done | 3114,3126,4154 |  | D3 | a234d127 |
| EM-3 | 기존 orders.parent_order_id/algo_run_id를 정본으로 쓰고 별도 parent_orders/child_ | done | 4901,6072,6126 |  | D3 | 4cc8c2a2 |
| EM-4 | domain/route/fee_model.py + liquidity_model.py + test | done | 2120,3115,3117 |  |  | a7898910 |
| EM-5 | domain/route/venue_scoring.py + test | done | 2120,3115,3117 |  |  | a7898910 |
| EM-6 | application/route_order.py + route_decisions 저장 + 통합 | done | 2526,3117,4155 |  | D2 | 619b9edf |
| EM-7 | domain/algo/guard.py + test | done | 2457,2499,3118 |  |  | aa6611b1 |
| EM-8 | domain/algo/twap.py — 기존 oms/domain/algo_slicer.py를 EMS 포트로 승격(재작성 금지) | done | 2461,3119 |  | D2 | b16e70c2 |
| EM-9 | domain/algo/vwap.py + test | done | 2501,3124 |  | D2 | 513e2773 |
| EM-10 | domain/algo/pov.py + test | done | 2499,3120,5196 |  |  | 916b608c |
| EM-11 | domain/algo/is_shortfall.py + test | done | 2502,3122 |  |  | 92f44b53 |
| EM-12 | domain/tca/benchmarks.py + test | done | 2867,3121,5197 |  | D2 | 6f6d6de5 |
| EM-13 | domain/tca/decomposition.py + test | done | 2511,3123,5198 |  |  | d7a1f8a6 |
| EM-14 | application/compute_tca.py + 저장 + 통합 | done | 4013,4032,5277 |  | D2 | 667d1aea |
| EM-15 | application/{start_algo,tick_algo,cancel_algo}.py + 스케줄러 배선 + 통합 | done | 2670,2671,4033 |  | D2 | fd40d70c |
| EM-16 | 적대적 스위트 tests/adversarial/ems/(게이트 우회·초과·터미널) | done | 2671 |  | D2 | 0e45c0c5 |
| EM-17 | ports/fix_session.py + 계약 테스트(어댑터 없이 포트만) | done | 2533,3125 | 2746 |  | 957ae247 |
| EM-18 | 프론트 ExecutionAlgoPage.tsx + TcaPage.tsx | done | 2672 | 6856 |  | 667d1aea |
<!-- spec-status:end -->
