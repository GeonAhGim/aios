...
갱신 2026-09-17T17:31:56+00:00 · 총 18 · done 17 · inflight 1 · untouched 0 · hold 0 · 재오픈 5 · 깊이(done) {'D2': 5, 'D3': 2, 'D?': 10}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| EM-1 | contracts/v1.py + 스냅샷 | done | 3115,3117,3125 |  | D2 | a7898910 |
| EM-2 | domain/parent_child.py + test — 감사 2026-09-06: 이미 구현된 부분이 있다. orders.p | done | 3114,3126,4154 |  | D3 | a234d127 |
| EM-3 | 기존 orders.parent_order_id/algo_run_id를 정본으로 쓰고 별도 parent_orders/child_ | done | 2121,3126,3542 | 4156 | D3 | 60ba097f |
...
| EM-6 | application/route_order.py + route_decisions 저장 + 통합 | done | 2120,2526,3117 | 4155 | D2 | a7898910 |
| EM-7 | domain/algo/guard.py + test | done | 2457,2499,3118 |  |  | aa6611b1 |
| EM-8 | domain/algo/twap.py — 기존 oms/domain/algo_slicer.py를 EMS 포트로 승격(재작성 금지) | done | 2461,3119 |  |  | b16e70c2 |
| EM-9 | domain/algo/vwap.py + test | done | 2501,3124 |  |  | 513e2773 |
| EM-10 | domain/algo/pov.py + test | done | 2499,3120 |  |  | 9375b821 |
| EM-11 | domain/algo/is_shortfall.py + test | done | 2502,3122 |  |  | 92f44b53 |
| EM-12 | domain/tca/benchmarks.py + test | done | 2526,2867,3121 |  | D2 | c0f655d2 |
| EM-13 | domain/tca/decomposition.py + test | done | 2511,3123 |  |  | 21f70fe4 |
| EM-14 | application/compute_tca.py + 저장 + 통합 | done | 2669,4012,4013 | 2672,4032 |  | 379d6e31 |
