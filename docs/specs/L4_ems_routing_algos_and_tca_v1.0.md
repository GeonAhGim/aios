...
갱신 2026-09-10T08:26:42+00:00 · 총 18 · done 14 · inflight 4 · untouched 0 · hold 0 · 재오픈 14 · 깊이(done) {'D?': 14}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| EM-1 | contracts/v1.py + 스냅샷 | done | 2526,2533,3125 | 3115,3116,3117 |  | 957ae247 |
| EM-2 | domain/parent_child.py + test — 감사 2026-09-06: 이미 구현된 부분이 있다. orders.p | done | 2070,2121 | 3114,3126 |  | f553385a |
| EM-3 | 기존 orders.parent_order_id/algo_run_id를 정본으로 쓰고 별도 parent_orders/child_ | done | 2121 | 3126 |  | f553385a |
...
| EM-6 | application/route_order.py + route_decisions 저장 + 통합 | done | 2120,2526 | 3117 |  | f18d1a20 |
...
| EM-12 | domain/tca/benchmarks.py + test | done | 2500,2526,2867 | 3121 |  | cd1a00de |
