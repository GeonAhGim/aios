...
갱신 2026-09-20T01:29:40+00:00 · 총 23 · done 23 · inflight 0 · untouched 0 · hold 0 · 재오픈 2 · 깊이(done) {'D2': 1, 'D?': 22}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| AI-1 | gateway/contracts/v1.py + 스냅샷 | done | 2635,4871 |  |  | 6b6b233f |
| AI-2 | domain/token_rules.py + domain/confirm.py + test | done | 2636,3680 |  |  | 191cc944 |
| AI-3 | 라이선스·의존성 확인 문서(docs/design/AI_DEPENDENCIES_EVAL.md: MCP SDK·anthropic  | done | 2637 | 4192 |  | 8222b088 |
| AI-4 | postgres_token_repository + 마이그레이션 + application/{issue,revoke,authori | done | 2638 |  |  | 1eee242c |
| AI-5 | providers/ports + domain/budget + prompt_registry + test | done | 2639 |  |  | 06c59719 |
...
| AI-10 | experiments/contracts + lineage + WORM 저장 + 마이그레이션 | done | 2371,2645,3052 |  |  | 43e408f7 |
| AI-11 | experiments/application/{record,query,compare} + 통합 | done | 2646,3680 |  |  | d717e929 |
...
| AI-17 | api/routers/ai.py(토큰 관리·제안·실험 조회) + 통합 | done | 2652,3680 |  |  | 02596876 |
