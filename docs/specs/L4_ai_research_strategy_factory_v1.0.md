...
갱신 2026-09-24T17:13:11+00:00 · 총 23 · done 23 · inflight 0 · untouched 0 · hold 0 · 재오픈 1 · 깊이(done) {'D2': 7, 'D?': 16}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| AI-1 | gateway/contracts/v1.py + 스냅샷 | done | 4871,5219,5238 |  |  |  |
| AI-2 | domain/token_rules.py + domain/confirm.py + test | done | 2636,3680 |  |  | 191cc944 |
| AI-3 | 라이선스·의존성 확인 문서(docs/design/AI_DEPENDENCIES_EVAL.md: MCP SDK·anthropic  | done | 2637,4192 |  |  | 3afbb56f |
| AI-4 | postgres_token_repository + 마이그레이션 + application/{issue,revoke,authori | done | 2638 |  | D2 | 1eee242c |
| AI-5 | providers/ports + domain/budget + prompt_registry + test | done | 2639,5224,5243 |  |  |  |
| AI-6 | anthropic_provider(구조화 출력, 비용 계측) + 계약 테스트(fake) | done | 2640,4878 | 4876 |  | eced4864 |
| AI-7 | openai_compatible_provider(OpenAI/Codex·로컬 LLM) + 계약 테스트(fake) | done | 2641 |  |  | 2bc718c8 |
| AI-7b | gemini_provider + 계약 테스트(fake) | done | 2642 |  |  | 6e39cbef |
| AI-8 | factory/contracts + domain/schema + proposal_rules + test | done | 2643 |  |  | 17b51923 |
| AI-9 | application/generate_proposal(공급자→스키마→컴파일→저장) + 통합 | done | 2644 |  |  | 285cb42c |
| AI-10 | experiments/contracts + lineage + WORM 저장 + 마이그레이션 | done | 2371,2645,3052 |  | D2 | 43e408f7 |
| AI-11 | experiments/application/{record,query,compare} + 통합 | done | 2646,3680,5248 |  |  |  |
| AI-12 | application/evaluate_proposal(검증 파이프라인 위임) + 통합 | done | 2647,3680 |  |  | a903dbae |
| AI-13 | application/promote_to_paper(확인 토큰 + 리스크 게이트) + 적대적 테스트 | done | 2648,3680 |  |  | a439b977 |
| AI-14 | application/research_tools(지표·백테스트·실험 위임) + test | done | 2649,3680 |  |  | 6702badf |
| AI-15 | src/api/mcp/server.py + tools_read/research(얇은 프록시) + 적대적(인간 JWT 거부) | done | 2650,3680 |  | D2 | 522825b2 |
| AI-16 | tools_propose/paper + 확인 토큰 왕복 + 적대적(재사용 409) | done | 2651,3680 |  | D2 | b76053af |
| AI-17 | api/routers/ai.py(토큰 관리·제안·실험 조회) + 통합 | done | 2652,3680 |  | D2 | 02596876 |
| AI-18 | ml/contracts + point_in_time + drift + test | done | 2653,3680 |  |  | 3671ef74 |
| AI-19 | ml ports + parquet_feature_store + postgres_model_registry + 마이그레이션 | done | 2654,3680 |  | D2 | 867ce62f |
| AI-20 | local_trainer + train_job(체크포인트) + register_model + 통합 | done | 2655 |  |  | d675c9c6 |
| AI-21 | serve_signal + indicators/catalog/ml.py(ml. 지표) + 증분=일괄 동일성 | done | 2656 |  |  | 759f89a8 |
| AI-22 | 프론트 AiStudioPage.tsx(공급자 설정·토큰·제안 목록·실험 비교·승격 버튼 확인 흐름) | done | 2657,5920 |  | D2 | 0d41e329 |
<!-- spec-status:end -->
