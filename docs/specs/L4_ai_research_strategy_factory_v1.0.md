...
갱신 2026-09-17T17:31:56+00:00 · 총 23 · done 23 · inflight 0 · untouched 0 · hold 0 · 재오픈 1 · 깊이(done) {'D2': 1, 'D?': 22}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| AI-1 | gateway/contracts/v1.py + 스냅샷 | done | 2635 |  |  | 69e61bd5 |
...
| AI-6 | anthropic_provider(구조화 출력, 비용 계측) + 계약 테스트(fake) | done | 2640 |  |  | 8a0117bb |
