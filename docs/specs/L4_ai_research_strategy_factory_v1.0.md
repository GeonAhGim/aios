...
갱신 2026-09-22T17:04:05+00:00 · 총 23 · done 23 · inflight 0 · untouched 0 · hold 0 · 재오픈 3 · 깊이(done) {'D2': 3, 'D?': 20}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| AI-1 | gateway/contracts/v1.py + 스냅샷 | done | 2635,4871,5238 | 5219 |  |  |
...
| AI-4 | postgres_token_repository + 마이그레이션 + application/{issue,revoke,authori | done | 2638 |  |  | 1eee242c |
| AI-5 | providers/ports + domain/budget + prompt_registry + test | done | 2639,5243 | 5224 |  |  |
...
| AI-15 | src/api/mcp/server.py + tools_read/research(얇은 프록시) + 적대적(인간 JWT 거부) | done | 2650,3680 |  |  | 522825b2 |
| AI-16 | tools_propose/paper + 확인 토큰 왕복 + 적대적(재사용 409) | done | 2651,3680 |  |  | b76053af |
...
| AI-19 | ml ports + parquet_feature_store + postgres_model_registry + 마이그레이션 | done | 2654,3680 |  |  | 867ce62f |
