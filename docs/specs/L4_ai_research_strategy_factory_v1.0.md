...
갱신 2026-09-16T17:30:45+00:00 · 총 23 · done 12 · inflight 11 · untouched 0 · hold 0 · 재오픈 11 · 깊이(done) {'D2': 1, 'D?': 11}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| AI-1 | gateway/contracts/v1.py + 스냅샷 | inflight |  | 2635 |  |  |
| AI-2 | domain/token_rules.py + domain/confirm.py + test | done | 3680 | 2636 |  | 4f28024d |
| AI-3 | 라이선스·의존성 확인 문서(docs/design/AI_DEPENDENCIES_EVAL.md: MCP SDK·anthropic  | inflight |  | 2637 |  |  |
| AI-4 | postgres_token_repository + 마이그레이션 + application/{issue,revoke,authori | inflight |  | 2638 |  |  |
| AI-5 | providers/ports + domain/budget + prompt_registry + test | inflight |  | 2639 |  |  |
| AI-6 | anthropic_provider(구조화 출력, 비용 계측) + 계약 테스트(fake) | inflight |  | 2640 |  |  |
| AI-7 | openai_compatible_provider(OpenAI/Codex·로컬 LLM) + 계약 테스트(fake) | inflight |  | 2641 |  |  |
| AI-7b | gemini_provider + 계약 테스트(fake) | inflight |  | 2642 |  |  |
| AI-8 | factory/contracts + domain/schema + proposal_rules + test | inflight |  | 2643 |  |  |
| AI-9 | application/generate_proposal(공급자→스키마→컴파일→저장) + 통합 | inflight |  | 2644 |  |  |
| AI-10 | experiments/contracts + lineage + WORM 저장 + 마이그레이션 | done | 2371,3052 | 2645 |  | f76a07e |
| AI-11 | experiments/application/{record,query,compare} + 통합 | done | 3680 | 2646 |  | 4f28024d |
| AI-12 | application/evaluate_proposal(검증 파이프라인 위임) + 통합 | done | 3680 | 2647 |  | 4f28024d |
| AI-13 | application/promote_to_paper(확인 토큰 + 리스크 게이트) + 적대적 테스트 | done | 3680 | 2648 |  | 4f28024d |
| AI-14 | application/research_tools(지표·백테스트·실험 위임) + test | done | 3680 | 2649 |  | 4f28024d |
| AI-15 | src/api/mcp/server.py + tools_read/research(얇은 프록시) + 적대적(인간 JWT 거부) | done | 3680 | 2650 |  | 4f28024d |
| AI-16 | tools_propose/paper + 확인 토큰 왕복 + 적대적(재사용 409) | done | 3680 | 2651 |  | 4f28024d |
| AI-17 | api/routers/ai.py(토큰 관리·제안·실험 조회) + 통합 | done | 3680 | 2652 |  | 4f28024d |
| AI-18 | ml/contracts + point_in_time + drift + test | done | 3680 | 2653 |  | 4f28024d |
| AI-19 | ml ports + parquet_feature_store + postgres_model_registry + 마이그레이션 | done | 3680 | 2654 |  | 4f28024d |
| AI-20 | local_trainer + train_job(체크포인트) + register_model + 통합 | inflight |  | 2655 |  |  |
| AI-21 | serve_signal + indicators/catalog/ml.py(ml. 지표) + 증분=일괄 동일성 | inflight |  | 2656 |  |  |
