...
갱신 2026-09-15T10:18:54+00:00 · 총 107 · done 86 · inflight 4 · untouched 0 · hold 17 · 재오픈 63 · 깊이(done) {'D1': 1, 'D2': 14, 'D3': 1, 'D?': 70}
...
| DC-8 | 마이그레이션 coverage_spans(EXCLUDE)/entitlements + 어댑터 + 통합 | done | 1212,2195,2884 | 2886 |  | 8bf909ed |
...
| DC-13 | adapters/storage/hot_postgres.py + 통합 | done | 2158,2349,2898 | 2886 |  | ba940298 |
| DC-14 | adapters/storage/warm_parquet.py + 통합 | done | 2350,2553,2899 | 2897 |  | f15e8a58 |
...
| CH-5 | backend charting 컨텍스트(계약·저장·API) + 통합·교차테넌트 테스트 | done | 3535,3543,3572 | 3076 | D2 | 8401a7a9 |
...
| CH-13 | 멀티 심볼 비교·오버레이(정규화 가격, 스프레드) + 페인 레이아웃 저장 | done | 1617,2662,3083 |  |  | 59893ed4 |
...
| CH-17 | 지표 템플릿(세트+설정+페인 배치) 저장·적용·공유 — backend charting 컨텍스트 확장 + 마켓 연동(MP 규칙  | done | 2027,2664,3091 | 2436,3627 | D2 | f82a4042 |
