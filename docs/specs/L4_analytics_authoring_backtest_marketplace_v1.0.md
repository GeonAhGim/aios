...
갱신 2026-09-22T11:11:33+00:00 · 총 107 · done 87 · inflight 3 · untouched 0 · hold 17 · 재오픈 15 · 깊이(done) {'D1': 1, 'D2': 32, 'D3': 19, 'D?': 35}
...
| DC-2 | domain/instruments/symbol_master.py + test | done | 1124,2876 | 4910,4911 |  | b55fff83 |
| DC-3 | domain/instruments/lifecycle.py + test | done | 1125,2875,3533 |  | D3 | dfe516a |
| DC-4 | 마이그레이션 instruments/venue_listings(EXCLUDE) + 통합 테스트 | done | 2892,3555,3556 |  | D3 | 13381616 |
| DC-5 | ports/provider.py, ports/instrument_repository.py, ports/coverage_repo | done | 2883,2884,2885 | 2552 | D3 | 8bf909ed |
| DC-6 | domain/coverage/registry.py + test | done | 2884,3559,3560 | 4915 | D3 | 43391d79 |
| DC-7 | domain/coverage/gaps.py + test | done | 2898,2991,4892 | 4894 | D3 | 7a52e609 |
| DC-8 | 마이그레이션 coverage_spans(EXCLUDE)/entitlements + 어댑터 + 통합 | done | 2195,2884,2886 |  | D3 | 823a0db3 |
| DC-9 | domain/entitlement/policy.py + test — LA-24 ports/entitlement.py Proto | done | 2895,3746,3750 | 2709 | D3 | 89f70e8f |
| DC-10 | domain/aggregation/timeframe_rollup.py + test | done | 2891,3038,3041 | 3561,4928 | D3 | 4a90abc8 |
| DC-11 | adapters/providers/base_adapter.py + test | done | 2885,2898,4892 | 4894 | D3 | 7a52e609 |
| DC-12 | adapters/providers/bitget_provider.py, kis_provider.py + 계약 테스트 | done | 1211,2885 |  | D3 | 6038373b |
| DC-13 | adapters/storage/hot_postgres.py + 통합 | done | 2886,2898,4892 | 4894 | D3 | 7a52e609 |
...
| DC-16 | application/backfill_job.py + 통합 | done | 2158,2898,4892 | 4894 | D3 | 7a52e609 |
...
| IND-1 | engine/incremental.py + engine/vectorized.py 동일성 property 테스트 | done | 2141,2916,2920 |  |  | bdfb23a6 |
| IND-2g | src/core/indicators/catalog/generate_from_talib.py + 생성 결과 catalog/tal | hold |  |  |  |  |
| IND-7g | reference/verify_all.py — 3자 교차검증: TA-Lib C 결과 ↔ 증분 엔진 ↔ 벡터 엔진을 같은 입력으 | done | 2331,2720,2927 | 4035,4036,4037 | D2 |  |
...
| IND-11 | adapters/pandas_ta_bridge.py + 검증 — 대상 패키지 pandas-ta-classic(MIT, Pyth | done | 2658,2720,2937 | 4035,4036,4037 |  |  |
| IND-12 | catalog/registry_tiers.py(코어/OSS/스크립트 3층, 이름 충돌·버전·해시 규칙) + GET /indic | done | 2926,3312,3399 | 2308 |  | a064c320 |
...
| BT-17 | backtest/vector/universe.py — 다종목 유니버스 스윕(컬럼 경로·메모리 상한) | done | 2372,3051 |  |  | 77871f6 |
...
| DC-19 | contracts/v2/microstructure.py — TradeTick·QuoteL1·BookL2(ts_event/ts_ | done | 2891,2892,2899 | 2552,4928 |  | c1a7ffba |
...
| DC-22 | domain/aggregation/tick_to_candle.py — 틱/호가 → 캔들 결정론 생성 + source_kind  | done | 2131,2891,2892 | 4928 | D3 | c1a7ffba |
