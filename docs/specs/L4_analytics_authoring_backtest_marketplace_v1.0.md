...
갱신 2026-09-10T08:26:42+00:00 · 총 107 · done 86 · inflight 4 · untouched 0 · hold 17 · 재오픈 68 · 깊이(done) {'D1': 1, 'D2': 11, 'D?': 74}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| SIG-1 | signals/contracts/v1.py + 스키마 테스트 | hold |  |  |  |  |
| SIG-2 | signals/domain/auth.py + test | hold |  |  |  |  |
| SIG-3 | signals/domain/normalize_tradingview.py + test | hold |  |  |  |  |
| SIG-4 | signals/application/ingest.py + outbox 통합 테스트 | hold |  |  |  |  |
| SIG-5 | api/routers/signals.py + 시크릿 회전(PLT-33) + 통합 테스트 | hold |  |  |  |  |
| SIG-6 | 프론트 SignalSourcesPage.tsx(시크릿 발급·회전·최근 수신 로그) | hold |  |  |  |  |
| DC-1 | contracts/v2/instruments.py + 스냅샷 | done | 1179,2068,2071 | 2881,2889,2890 |  | 24e25a66 |
| DC-2 | domain/instruments/symbol_master.py + test | done | 1124 | 2876 |  | 7ffefc0 |
| DC-3 | domain/instruments/lifecycle.py + test | done | 1125,2875 |  |  | 6bbf82b2 |
| DC-4 | 마이그레이션 instruments/venue_listings(EXCLUDE) + 통합 테스트 | done | 1153,1195,2130 | 2879,2884,2892 |  | ae186957 |
| DC-5 | ports/provider.py, ports/instrument_repository.py, ports/coverage_repo | done | 1187,1195,1211 | 2883,2884,2885 |  | 5ce38ce |
| DC-6 | domain/coverage/registry.py + test | done | 1127,1178,1195 | 2878,2882,2884 |  | d332f07 |
| DC-7 | domain/coverage/gaps.py + test | done | 1178,2158 | 2882,2898,2991 |  | e4d23ca4 |
| DC-8 | 마이그레이션 coverage_spans(EXCLUDE)/entitlements + 어댑터 + 통합 | done | 1195,1212,2195 | 2884,2886,2893 |  | ddacfca6 |
| DC-9 | domain/entitlement/policy.py + test — LA-24 ports/entitlement.py Proto | done | 1179,2330 | 2709,2881,2895 |  | ff2b6fa1 |
| DC-10 | domain/aggregation/timeframe_rollup.py + test | done | 1351,1556,2131 | 2891,3038,3041 |  | f702898b |
| DC-11 | adapters/providers/base_adapter.py + test | done | 1187,1211,2158 | 2883,2885,2898 |  | e4d23ca4 |
| DC-12 | adapters/providers/bitget_provider.py, kis_provider.py + 계약 테스트 | done | 1211 | 2885 |  | 5ce38ce |
| DC-13 | adapters/storage/hot_postgres.py + 통합 | done | 1212,2158,2349 | 2886,2896,2898 |  | e4d23ca4 |
| DC-14 | adapters/storage/warm_parquet.py + 통합 | done | 2350,2553,2899 | 2896,2897 |  | f15e8a58 |
| DC-15 | adapters/storage/tiering.py + 잡 테스트 | done | 2350 | 2897 |  | bd9adb48 |
| DC-16 | application/backfill_job.py + 통합 | done | 2158 | 2898 |  | e4d23ca4 |
| DC-17 | application/realtime_fanout.py + 테스트 | done | 2330 | 2621,2895 |  | ff2b6fa1 |
| DC-18 | 커버리지 API GET /market-data/coverage + 프론트 CoverageBadge | done | 2894,3319,3424 | 2893 |  | 06d7a7f8 |
| IND-1 | engine/incremental.py + engine/vectorized.py 동일성 property 테스트 | done | 1728,1729,2141 | 2916,2920 |  | a6b9c7e4 |
| IND-2g | src/core/indicators/catalog/generate_from_talib.py + 생성 결과 catalog/tal | hold |  |  |  |  |
| IND-7g | reference/verify_all.py — 3자 교차검증: TA-Lib C 결과 ↔ 증분 엔진 ↔ 벡터 엔진을 같은 입력으 | done | 1953,2326,2331 | 2720,2927 |  | 0b50cad8 |
| IND-8 | custom/dsl_indicator.py + test | inflight |  | 2308 |  |  |
| DSL-1 | grammar/ast.py + 직렬화 왕복 테스트 | done | 1369,1503,1555 | 2909 |  | 0d4b4ca |
| DSL-2 | grammar/lexer.py + test | done | 1337,1369,1535 | 2910 | D2 | 8c0c10e |
| DSL-3 | grammar/parser.py + test | done | 1535,1555,2307 | 2911,2912 | D2 | b720f908 |
| DSL-4 | typing/types.py, typing/checker.py + test | done | 1502,1503,1535 | 2912 | D2 | 8c0c10e |
| DSL-5 | analysis/lookahead.py + test | done | 1369,1535 | 2913 | D2 | 8c0c10e |
| DSL-6 | analysis/resources.py + test | done | 1502,1535 | 2914 | D2 | 8c0c10e |
| DSL-7 | ir/ops.py, ir/lower.py + test | done | 1522,1535,1625 | 2915,3042 | D2 | fe6182b |
| DSL-8 | runtime/series.py, runtime/interpreter.py + property 테스트 | done | 1625,2140,2324 | 2917,3042,3049 |  | 13e16cc2 |
| DSL-9 | runtime/builtins_ta.py, builtins_math.py, builtins_strategy.py + test | done | 1554,2140,2182 | 2308,2929 |  | b404e37e |
| DSL-10 | compat/cond_v2_bridge.py + 전 케이스 왕복 테스트 + compat_map 저장 | done | 1555,2182 | 2921 |  | b404e37e |
| DSL-11 | src/core/strategy/script_facade.py + 회귀 테스트 | done | 2182,2521 | 2931,3216 |  | b137cfb0 |
| DSL-12 | artifact/hash.py + POST /scripts/compile API + 오류 위치 응답 | done | 1558,1606,1625 | 2918,3041,3042 | D2 | fe6182b |
| DSL-13 | 프론트 ScriptEditorPage.tsx(Monaco, 오류 마커, 컴파일 미리보기) | done | 1592,1606,1808 |  |  | 1ce7831 |
| BT-1 | domain/models_v2.py + 스냅샷 | done | 1351,1368,1556 | 3038,3039,3041 |  | b0ac7ef |
| BT-2 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 1556,2324,2325 | 3041,3049,3050 |  | 0c4971a9 |
| BT-3 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 1556,2324,2325 | 3041,3049,3050 |  | 0c4971a9 |
| BT-4 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 1556,2324,2325 | 3041,3049,3050 |  | 0c4971a9 |
| BT-5 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 1556,2324,2325 | 3041,3049,3050 |  | 0c4971a9 |
| BT-6 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 1556,2324,2325 | 3041,3049,3050 |  | 0c4971a9 |
| BT-7 | domain/magnifier.py + test | done | 1351,1504 | 3038,3040 |  | 9a1ae87 |
| BT-8 | domain/costs/{funding,borrow}.py + test | done | 1368,1504 | 3039,3040 |  | 9a1ae87 |
| BT-9 | domain/reproducibility.py + test | done | 1556,2152 | 3041,3047 |  | ba3b308a |
| BT-10 | application/quick_backtest.py + 통합(컬럼 경로) | done | 2152,2159,3044 | 3043,3047,3054 | D2 | 7b420a13 |
| BT-11 | application/deep_backtest_job.py + 체크포인트 통합 | done | 2152 | 3047 |  | ba3b308a |
| BT-12 | application/tearsheet.py + performance 계약 재사용 | done | 2159 | 3054 |  | 072e931f |
| BT-13 | 프론트 차트 즉시 백테스트 패널(BacktestPanel.tsx) + 결과 마커 | done | 1607,3044 |  |  | 7b420a13 |
| CH-0 | docs/design/CHART_ENGINE_FORK_EVAL.md + 벤치 스크립트 | done | 1536,2181,3068 | 2666,3048 |  | 74434f1f |
| CH-1 | packages/chart-engine 골격 + vendor/에 포크 반입(NOTICE·LICENSE) + src/core/. | done | 1501,1523,1559 |  |  | 8ec0980 |
| CH-2 | data/candleStream.ts + 테스트 | done | 3074,3319,3424 |  |  | 06d7a7f8 |
...
| CH-5 | backend charting 컨텍스트(계약·저장·API) + 통합·교차테넌트 테스트 | done | 2101,2168,3309 | 3076 | D2 | 02a788dc |
| CH-6 | ChartPage.tsx + ChartToolbar.tsx + IndicatorPicker.tsx | done | 1607,3044,3081 |  |  | 3fcd7b7b |
| CH-7 | replay/replayController.ts + 데이터 동일성 테스트 | done | 1559,2453,3075 |  |  | 4046b1d0 |
...
| MP-1 | marketplace/contracts/v1.py + 스냅샷 | hold |  |  |  |  |
| MP-2 | domain/visibility.py + test | hold |  |  |  |  |
| MP-3 | domain/versioning.py + test | hold | 2373 | 2935 |  | e802ec59 |
| MP-4 | domain/reputation.py + test | hold |  |  |  |  |
| MP-5 | domain/plagiarism.py + test | hold |  |  |  |  |
| MP-6 | domain/subscription_rules.py + test | hold |  |  |  |  |
| MP-7 | 마이그레이션 + adapters/postgres_.py + 통합·교차테넌트 | hold |  |  |  |  |
| MP-8 | ledger/domain/posting_rules_marketplace.py + 분개 테스트 | hold |  |  |  |  |
| MP-9 | application/{publish,subscribe,moderate}.py + 통합 | hold |  |  |  |  |
| MP-10 | 프론트 MarketplaceBrowse·ListingDetail·SellStrategy 확장(가시성·구독·평판·재현 키) | hold |  |  |  |  |
| IND-9 | docs/design/INDICATOR_OSS_EVAL.md — TA-Lib·pandas-ta·ta 라이선스 원문·종수·품질( | done | 1536,1729,2181 | 2919,3048 |  | 1b53ad92 |
| IND-11 | adapters/pandas_ta_bridge.py + 검증 — 대상 패키지 pandas-ta-classic(MIT, Pyth | done | 2658 | 2720,2937 |  |  |
| IND-12 | catalog/registry_tiers.py(코어/OSS/스크립트 3층, 이름 충돌·버전·해시 규칙) + GET /indic | done | 2331,3312,3399 | 2308,2926 |  | 934b8d18 |
| IND-13 | 참조 벡터 대량 검증 잡(reference/verify_all.py, nightly) + CI 샘플링 | done | 2326,2331 | 2933,2934 |  | 0b50cad8 |
| IND-14 | 프론트 IndicatorPicker 확장(3층 탐색·검색·즐겨찾기·스크립트 지표 즉시 미리보기) | done | 1915,2454,2928 |  |  | 350fcc24 |
| BT-14 | docs/design/BACKTEST_VECTOR_EVAL.md — vectorbt OSS(Apache-2.0)·zipline | done | 2181,2324 | 3048,3049 |  | 13e16cc2 |
| BT-15 | backtest/vector/{arrays,signals,fills}.py — numpy/numba 벡터화 엔진 코어(체결 모 | done | 2181,2324,2325 | 3048,3049,3050 |  | 0c4971a9 |
| BT-16 | backtest/vector/{grid,walk_forward,monte_carlo}.py — 파라미터 그리드·워크포워드·Mo | done | 2426,2428,3055 | 2660,3053 |  | bda12580 |
| BT-17 | backtest/vector/universe.py — 다종목 유니버스 스윕(컬럼 경로·메모리 상한) | done | 2372 | 3051 |  | 77871f67 |
| BT-18 | 프론트 SweepResultsPage.tsx(히트맵·안정성 표면·재현 키) | done | 2428,3055 |  |  | bda12580 |
| DSL-14 | script/import/pine/{lexer,parser}.py — Pine Script v5 부분 문법(입력·시리즈 연산· | done | 2307 | 2932 |  | b720f908 |
| DSL-15 | script/import/pine/transpile.py — Pine AST → AIOS Script 변환 + 컴파일·검증 왕 | done | 2374 | 2936 |  | ca61dfd1 |
| DSL-16 | script/library/{imports,registry}.py — 스크립트 라이브러리 import(import lib.na | inflight |  | 2661 |  |  |
...
| CH-13 | 멀티 심볼 비교·오버레이(정규화 가격, 스프레드) + 페인 레이아웃 저장 | done | 1616,1617,3083 | 2662 |  | a89dbdee |
| DC-19 | contracts/v2/microstructure.py — TradeTick·QuoteL1·BookL2(ts_event/ts_ | done | 2131,2553,2899 | 2889,2891,2892 |  | f15e8a58 |
| DC-20 | contracts/v2/instruments.py 확장 — kind(spot\ | done | 2130,2554,2900 | 2890,2892 |  | 0126c979 |
| DC-21 | domain/point_in_time.py(FA-9 core/bitemporal.py 위임, 재구현 금지) + 참조 데이터 k | done | 2130 | 2892 |  | ae186957 |
| DC-22 | domain/aggregation/tick_to_candle.py — 틱/호가 → 캔들 결정론 생성 + source_kind  | done | 2130,2131 | 2891,2892 |  | ae186957 |
| DC-23 | adapters/storage/tick_parquet.py — 틱·호가 warm 저장(일자×종목 파티션, 컬럼지향 직접 로드) | done | 2553,2899 |  |  | f15e8a58 |
| DC-24 | ports/provider.py 확장 — fetch_trades/fetch_quotes/subscribe_book(선택 cap | inflight |  | 2552 |  |  |
| DC-25 | 파생상품 캘린더·만기 롤 규칙(domain/instruments/roll.py) + 연속선물 시리즈 생성 | done | 2554,2900 |  |  | 0126c979 |
| DC-26 | 옵션 체인 조회 API(GET /market-data/options/chain) + 그리스 계산은 지표(IND)로 위임하는 경 | inflight |  | 2663 |  |  |
| IND-15 | core/indicators/spec.py 확장 — PlotSpec{kind: line\ | done | 1728,1732 | 2924 |  | 6c714c2 |
| IND-16 | 지표 입력 소스로 다른 지표 출력 허용(indicator-on-indicator) — 레지스트리 의존 그래프·순환 탐지·loo | done | 2141 | 2930 |  | a6b9c7e4 |
| CH-14 | chart-engine/src/panes/{paneModel,paneLayout,crosshairSync}.ts — KLine | done | 2454,3084,3092 | 2436 |  | ee0cdbbe |
| CH-15 | chart-engine/src/render/{plotRenderers,scaleBinding,fillBetween}.ts —  | done | 2078,2127,3087 | 2436,3101 |  | 7a38c2f8 |
| CH-16 | chart-engine/src/legend/{statusLine,dataWindow,objectTree}.ts — status | done | 2078,3085,3092 | 2436,3105 | D2 | ee0cdbbe |
| CH-17 | 지표 템플릿(세트+설정+페인 배치) 저장·적용·공유 — backend charting 컨텍스트 확장 + 마켓 연동(MP 규칙  | done | 2011,2027,3091 | 2436,2664 | D2 | 0014150e |
| CH-18 | chart-engine/src/compute/{workerPool,clientEngine,parityCheck}.ts — We | done | 2039,2098,2454 | 2436,2665 |  | 4dee9674 |
| CH-19 | 렌더 성능: 레이어 분리·뷰포트 밖 계산 생략·LOD 다운샘플링(극값 보존)·오프스크린 캔버스 + 밀도 벤치(CH-0 스크립트 | done | 2052,2089,2097 | 2436,2666 |  |  |
<!-- spec-status:end -->
