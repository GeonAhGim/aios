...
갱신 2026-09-12T17:04:32+00:00 · 총 107 · done 86 · inflight 4 · untouched 0 · hold 17 · 재오픈 65 · 깊이(done) {'D1': 1, 'D2': 11, 'D?': 74}
...
| DC-1 | contracts/v2/instruments.py + 스냅샷 | done | 2068,2071,2881 | 2874,2889,2890 |  | 05f412c3 |
| DC-2 | domain/instruments/symbol_master.py + test | done | 1124 | 2876 |  | 7ffefc0 |
| DC-3 | domain/instruments/lifecycle.py + test | done | 1125,2875 | 3533 |  | 6bbf82b2 |
| DC-4 | 마이그레이션 instruments/venue_listings(EXCLUDE) + 통합 테스트 | done | 2879,2884,2892 | 3555,3556 |  | b82279eb |
| DC-5 | ports/provider.py, ports/instrument_repository.py, ports/coverage_repo | done | 2883,2884,2885 | 2552 |  | 8bf909ed |
| DC-6 | domain/coverage/registry.py + test | done | 1195,2878,2884 | 2882,3559,3560 |  | 8bf909ed |
| DC-7 | domain/coverage/gaps.py + test | done | 1178,2158,2898 | 2882,2991 |  | ba940298 |
| DC-8 | 마이그레이션 coverage_spans(EXCLUDE)/entitlements + 어댑터 + 통합 | done | 1212,2195,2884 | 2886,2893 |  | 8bf909ed |
| DC-9 | domain/entitlement/policy.py + test — LA-24 ports/entitlement.py Proto | done | 2330,2881,2895 | 2709 |  | 9c4591e7 |
| DC-10 | domain/aggregation/timeframe_rollup.py + test | done | 1556,2131,2880 | 3038,3041,3561 |  | 60604dde |
| DC-11 | adapters/providers/base_adapter.py + test | done | 2883,2885,2898 |  |  | ba940298 |
| DC-12 | adapters/providers/bitget_provider.py, kis_provider.py + 계약 테스트 | done | 1211,2885 |  |  | 6038373b |
| DC-13 | adapters/storage/hot_postgres.py + 통합 | done | 2158,2349,2898 | 2886,2896 |  | ba940298 |
...
| DC-16 | application/backfill_job.py + 통합 | done | 2158,2898 |  |  | ba940298 |
| DC-17 | application/realtime_fanout.py + 테스트 | done | 2330,2895 | 2621 |  | 9c4591e7 |
...
| CH-5 | backend charting 컨텍스트(계약·저장·API) + 통합·교차테넌트 테스트 | done | 2168,3309,3535 | 3076,3543 | D2 | 8401a7a9 |
...
| DC-19 | contracts/v2/microstructure.py — TradeTick·QuoteL1·BookL2(ts_event/ts_ | done | 2553,2892,2899 | 2552,2889,2891 |  | b82279eb |
| DC-20 | contracts/v2/instruments.py 확장 — kind(spot\ | done | 2554,2892,2900 | 2890 |  | b82279eb |
| DC-21 | domain/point_in_time.py(FA-9 core/bitemporal.py 위임, 재구현 금지) + 참조 데이터 k | done | 2130,2892 |  |  | b82279eb |
| DC-22 | domain/aggregation/tick_to_candle.py — 틱/호가 → 캔들 결정론 생성 + source_kind  | done | 2130,2131,2892 | 2891 |  | b82279eb |
...
| CH-15 | chart-engine/src/render/{plotRenderers,scaleBinding,fillBetween}.ts —  | done | 2127,3087,3101 | 2436 |  | c20cb1e0 |
