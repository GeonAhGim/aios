...
| **IND-2g** | `src/core/indicators/generate_specs.py`(생성기) + `specs_talib.py`(11종 수동 오버라이드를 얹은 `TALIB_SPECS`) — `talib.get_functions()`(설치된 버전이 종수 결정, 리터럴 고정 금지) × `abstract.Function(n).info`에서 `group`·`input_names`·`parameters`(기본값)·`output_names`·`output_flags`를 읽어 `IndicatorSpec`을 생성하고 `lookback`은 `.lookback` 실측값 사용. **`PlotSpec` 기본값은 `output_flags`에서 자동 도출**(Line→line, Dashed Line→line(dashed), Histogram→histogram, upper/lower limit 쌍→band+fill_between). 파라미터 범위는 기본값 기반 규칙(정수 주기 1~2000, 편차 0.1~10). (task-8232: 별도 생성기 `catalog/generate_from_talib.py` + 스냅샷 `catalog/talib_generated*.py`는 소비자 0으로 중복 제거 — #118 TA-Lib 0.8.1 대응은 이 파일 하나로 단일화) | IND-1, IND-15 | 설치된 TA-Lib 전량 등록(버전별 종수 상이 허용), 그룹 10종 분류, 캔들 패턴 61종(TA-Lib 0.4.x 기준) 포함, 생성 재실행 시 동일 산출(결정론), TA-Lib 미설치 시 모듈 import가 fail-closed | 300 |
...
갱신 2026-09-24T17:13:11+00:00 · 총 107 · done 89 · inflight 1 · untouched 0 · hold 17 · 재오픈 0 · 깊이(done) {'D1': 1, 'D2': 37, 'D3': 19, 'D?': 32}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| SIG-1 | signals/contracts/v1.py + 스키마 테스트 | hold | 5998 |  |  | 763e9e24 |
| SIG-2 | signals/domain/auth.py + test | hold | 5998 |  |  | 763e9e24 |
| SIG-3 | signals/domain/normalize_tradingview.py + test | hold | 5998 |  |  | 763e9e24 |
| SIG-4 | signals/application/ingest.py + outbox 통합 테스트 | hold | 5998 |  |  | 763e9e24 |
| SIG-5 | api/routers/signals.py + 시크릿 회전(PLT-33) + 통합 테스트 | hold | 5998 |  |  | 763e9e24 |
| SIG-6 | 프론트 SignalSourcesPage.tsx(시크릿 발급·회전·최근 수신 로그) | hold | 5998 |  |  | 763e9e24 |
| DC-1 | contracts/v2/instruments.py + 스냅샷 | done | 2881,2889,2890 |  | D3 | 9fbca88c |
| DC-2 | domain/instruments/symbol_master.py + test | done | 2876,4910,4911 |  |  | 5d7e1376 |
| DC-3 | domain/instruments/lifecycle.py + test | done | 2875,3533,5494 |  | D3 | 2101ddc6 |
| DC-4 | 마이그레이션 instruments/venue_listings(EXCLUDE) + 통합 테스트 | done | 2892,3555,3556 |  | D3 | 13381616 |
| DC-5 | ports/provider.py, ports/instrument_repository.py, ports/coverage_repo | done | 2883,2884,2885 |  | D3 | 17b6ae7a |
| DC-6 | domain/coverage/registry.py + test | done | 3559,3560,4915 |  | D3 | 946253a4 |
| DC-7 | domain/coverage/gaps.py + test | done | 2991,4892,4894 |  | D3 | 4874392d |
| DC-8 | 마이그레이션 coverage_spans(EXCLUDE)/entitlements + 어댑터 + 통합 | done | 2195,2884,2886 |  | D3 | 823a0db3 |
| DC-9 | domain/entitlement/policy.py + test — LA-24 ports/entitlement.py Proto | done | 2895,3746,3750 |  | D3 | 9359c634 |
| DC-10 | domain/aggregation/timeframe_rollup.py + test | done | 3041,3561,4928 |  | D3 | 2984b706 |
| DC-11 | adapters/providers/base_adapter.py + test | done | 2898,4892,4894 |  | D3 | 4874392d |
| DC-12 | adapters/providers/bitget_provider.py, kis_provider.py + 계약 테스트 | done | 1211,2885 |  | D3 | 6038373b |
| DC-13 | adapters/storage/hot_postgres.py + 통합 | done | 2898,4892,4894 |  | D3 | 4874392d |
| DC-14 | adapters/storage/warm_parquet.py + 통합 | done | 2553,2897,2899 |  |  | c37bc444 |
| DC-15 | adapters/storage/tiering.py + 잡 테스트 | done | 2350,2897,4164 |  |  | c7e776d0 |
| DC-16 | application/backfill_job.py + 통합 | done | 2898,4892,4894 |  | D3 | 4874392d |
| DC-17 | application/realtime_fanout.py + 테스트 | done | 2621,2895,4163 |  |  | 4a4025a6 |
| DC-18 | 커버리지 API GET /market-data/coverage + 프론트 CoverageBadge | done | 2894,3319,3424 |  |  | 06d7a7f8 |
| IND-1 | engine/incremental.py + engine/vectorized.py 동일성 property 테스트 | done | 2920,5600,5649 |  | D2 |  |
| IND-2g | src/core/indicators/catalog/generate_from_talib.py + 생성 결과 catalog/tal | hold |  |  |  |  |
| IND-7g | reference/verify_all.py — 3자 교차검증: TA-Lib C 결과 ↔ 증분 엔진 ↔ 벡터 엔진을 같은 입력으 | done | 4035,4036,4037 |  | D2 | be9d98fe |
| IND-8 | custom/dsl_indicator.py + test | done | 2308 |  |  | 1f44dab6 |
| DSL-1 | grammar/ast.py + 직렬화 왕복 테스트 | done | 1503,1555,2909 |  |  | 9fc5b7dd |
| DSL-2 | grammar/lexer.py + test | done | 1369,1535,2910 |  | D2 | 1828133c |
| DSL-3 | grammar/parser.py + test | done | 2307,2911,2912 |  | D2 | fa460cef |
| DSL-4 | typing/types.py, typing/checker.py + test | done | 1503,1535,2912 |  | D2 | 62819981 |
| DSL-5 | analysis/lookahead.py + test | done | 1369,1535,2913 |  | D2 | cb2a0a8a |
| DSL-6 | analysis/resources.py + test | done | 1502,1535,2914 |  | D2 | 2850a3e8 |
| DSL-7 | ir/ops.py, ir/lower.py + test | done | 1625,2915,3042 |  | D2 | 4155d55d |
| DSL-8 | runtime/series.py, runtime/interpreter.py + property 테스트 | done | 3042,3049,4146 |  | D2 | 6db8624b |
| DSL-9 | runtime/builtins_ta.py, builtins_math.py, builtins_strategy.py + test | done | 2182,2308,2929 |  |  | 1f44dab6 |
| DSL-10 | compat/cond_v2_bridge.py + 전 케이스 왕복 테스트 + compat_map 저장 | done | 1555,2182,2921 |  |  | 1d73fbd0 |
| DSL-11 | src/core/strategy/script_facade.py + 회귀 테스트 | done | 2521,2931,3216 |  |  | 9d54b295 |
| DSL-12 | artifact/hash.py + POST /scripts/compile API + 오류 위치 응답 | done | 3041,3042,6357 |  | D2 | 8289637e |
| DSL-13 | 프론트 ScriptEditorPage.tsx(Monaco, 오류 마커, 컴파일 미리보기) | done | 1592,1606,1808 |  |  | 1ce7831 |
| BT-1 | domain/models_v2.py + 스냅샷 | done | 3038,3039,3041 |  | D2 | 6fe3669d |
| BT-2 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 3041,3049,3050 |  | D2 |  |
| BT-3 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 3041,3049,3050 |  | D2 | 4a90abc8 |
| BT-4 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 3041,3049,3050 |  | D2 | 4a90abc8 |
| BT-5 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 3041,3049,3050 |  | D2 | 4a90abc8 |
| BT-6 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 3041,3049,3050 |  | D2 | 4a90abc8 |
| BT-7 | domain/magnifier.py + test | done | 1504,3038,3040 |  | D2 | 9a1ae87 |
| BT-8 | domain/costs/{funding,borrow}.py + test | done | 1504,3039,3040 |  | D2 | b612191e |
| BT-9 | domain/reproducibility.py + test | done | 2152,3041,3047 |  | D2 | b3259127 |
| BT-10 | application/quick_backtest.py + 통합(컬럼 경로) | done | 3044,3047,3054 |  | D2 | b3259127 |
| BT-11 | application/deep_backtest_job.py + 체크포인트 통합 | done | 2152,3047 |  |  | b3259127 |
| BT-12 | application/tearsheet.py + performance 계약 재사용 | done | 2159,3054,3884 |  | D2 | cd9fbde2 |
| BT-13 | 프론트 차트 즉시 백테스트 패널(BacktestPanel.tsx) + 결과 마커 | done | 1607,3044 |  | D2 | 7b420a13 |
| CH-0 | docs/design/CHART_ENGINE_FORK_EVAL.md + 벤치 스크립트 | done | 4193,4194,4195 |  | D2 | fd614b05 |
| CH-1 | packages/chart-engine 골격 + vendor/에 포크 반입(NOTICE·LICENSE) + src/core/. | done | 1523,1559,4193 |  |  | b0826da |
| CH-2 | data/candleStream.ts + 테스트 | done | 3074,3319,3424 |  | D3 | 06d7a7f8 |
| CH-3 | indicators/overlayRegistry.ts + 테스트 | done | 1731,3070,3318 |  |  | bc2faef9 |
| CH-4 | drawings/{model,tools,serialize}.ts — 벤더 오버레이 위임 어댑터. KLineChart exten | done | 2012,2101,3071 |  | D1 | 8a6e2621 |
| CH-5 | backend charting 컨텍스트(계약·저장·API) + 통합·교차테넌트 테스트 | done | 3535,3543,3572 |  | D2 | 558101c1 |
| CH-6 | ChartPage.tsx + ChartToolbar.tsx + IndicatorPicker.tsx | done | 1607,3044,3081 |  | D2 | 3fcd7b7b |
| CH-7 | replay/replayController.ts + 데이터 동일성 테스트 | done | 1559,2453,3075 |  | D2 | 4046b1d0 |
| CH-8 | layout/{layoutModel,persistence}.ts + 서버 저장 | done | 2466,3080,3304 |  |  | f2ff14d5 |
| CH-9 | AlertFromChart.tsx + 알림 규칙 API 연결 | done | 1570,3079 |  |  | 4d6af08f |
| CH-10 | StrategyMarkers.tsx(신호·체결 마커, 실행 상태 연동) | done | 1569,2997,3078 |  |  | 1422493e |
| MP-1 | marketplace/contracts/v1.py + 스냅샷 | hold | 6357,6358 |  |  | ef1e4e3c |
| MP-2 | domain/visibility.py + test | hold | 6357,6358 |  |  | ef1e4e3c |
| MP-3 | domain/versioning.py + test | hold | 2373,2935,6357 |  |  | 8289637e |
| MP-4 | domain/reputation.py + test | hold | 6357 |  |  | 8289637e |
| MP-5 | domain/plagiarism.py + test | hold | 6357 |  |  | 8289637e |
| MP-6 | domain/subscription_rules.py + test | hold | 6357 |  |  | 8289637e |
| MP-7 | 마이그레이션 + adapters/postgres_.py + 통합·교차테넌트 | hold | 6357 |  |  | 8289637e |
| MP-8 | ledger/domain/posting_rules_marketplace.py + 분개 테스트 | hold | 6357 |  |  | 8289637e |
| MP-9 | application/{publish,subscribe,moderate}.py + 통합 | hold | 6357 |  |  | 8289637e |
| MP-10 | 프론트 MarketplaceBrowse·ListingDetail·SellStrategy 확장(가시성·구독·평판·재현 키) | hold | 6357 |  |  | 8289637e |
| IND-9 | docs/design/INDICATOR_OSS_EVAL.md — TA-Lib·pandas-ta·ta 라이선스 원문·종수·품질( | done | 2919,3048,4194 |  | D2 | 5d01c4eb |
| IND-11 | adapters/pandas_ta_bridge.py + 검증 — 대상 패키지 pandas-ta-classic(MIT, Pyth | done | 4035,4036,4037 |  | D2 |  |
| IND-12 | catalog/registry_tiers.py(코어/OSS/스크립트 3층, 이름 충돌·버전·해시 규칙) + GET /indic | done | 2926,3312,3399 |  |  | 1f44dab6 |
| IND-13 | 참조 벡터 대량 검증 잡(reference/verify_all.py, nightly) + CI 샘플링 | done | 2933,2934,4162 |  | D2 | 6e80c35b |
| IND-14 | 프론트 IndicatorPicker 확장(3층 탐색·검색·즐겨찾기·스크립트 지표 즉시 미리보기) | done | 1915,2454,2928 |  |  | 350fcc24 |
| BT-14 | docs/design/BACKTEST_VECTOR_EVAL.md — vectorbt OSS(Apache-2.0)·zipline | done | 3048,3049,4195 |  | D2 | fd614b05 |
| BT-15 | backtest/vector/{arrays,signals,fills}.py — numpy/numba 벡터화 엔진 코어(체결 모 | done | 6397,6415,6453 |  | D2 | 78323725 |
| BT-16 | backtest/vector/{grid,walk_forward,monte_carlo}.py — 파라미터 그리드·워크포워드·Mo | done | 2660,3053,3055 |  |  |  |
| BT-17 | backtest/vector/universe.py — 다종목 유니버스 스윕(컬럼 경로·메모리 상한) | done | 2372,3051 |  | D2 | 77871f6 |
| BT-18 | 프론트 SweepResultsPage.tsx(히트맵·안정성 표면·재현 키) | done | 2428,3055 |  |  | bda12580 |
| DSL-14 | script/import/pine/{lexer,parser}.py — Pine Script v5 부분 문법(입력·시리즈 연산· | done | 2307,2932,4161 |  |  | abaf177e |
| DSL-15 | script/import/pine/transpile.py — Pine AST → AIOS Script 변환 + 컴파일·검증 왕 | done | 2374,2936 |  | D2 | 266482d |
| DSL-16 | script/library/{imports,registry}.py — 스크립트 라이브러리 import(import lib.na | done | 2661 |  |  |  |
| CH-11 | chart-engine/src/plugins/indicatorPlugin.ts — 벤더 registerIndicator/Ind | done | 1732,1808,3086 |  |  | ea522ceb |
| CH-12 | chart-engine/src/plugins/scriptPreview.ts + 편집기 연동 — 스크립트 지표/전략 즉시 미리보 | done | 1808,3088 |  |  | 2f09ce6b |
| CH-13 | 멀티 심볼 비교·오버레이(정규화 가격, 스프레드) + 페인 레이아웃 저장 | done | 4907,4908,4909 |  |  | f7697f70 |
| DC-19 | contracts/v2/microstructure.py — TradeTick·QuoteL1·BookL2(ts_event/ts_ | done | 2892,2899,4928 |  |  | 17b6ae7a |
| DC-20 | contracts/v2/instruments.py 확장 — kind(spot\ | done | 2890,2892,2900 |  | D3 | 9fbca88c |
| DC-21 | domain/point_in_time.py(FA-9 core/bitemporal.py 위임, 재구현 금지) + 참조 데이터 k | done | 2130,2892,4157 |  | D3 | 5ea3b6f5 |
| DC-22 | domain/aggregation/tick_to_candle.py — 틱/호가 → 캔들 결정론 생성 + source_kind  | done | 2891,2892,4928 |  | D3 | 2984b706 |
| DC-23 | adapters/storage/tick_parquet.py — 틱·호가 warm 저장(일자×종목 파티션, 컬럼지향 직접 로드) | done | 2553,2899 |  |  | f15e8a58 |
| DC-24 | ports/provider.py 확장 — fetch_trades/fetch_quotes/subscribe_book(선택 cap | done | 2552 |  |  | 17b6ae7a |
| DC-25 | 파생상품 캘린더·만기 롤 규칙(domain/instruments/roll.py) + 연속선물 시리즈 생성 | done | 2554,2900 |  |  | 0126c979 |
| DC-26 | 옵션 체인 조회 API(GET /market-data/options/chain) + 그리스 계산은 지표(IND)로 위임하는 경 | inflight |  | 4903 |  |  |
| IND-15 | core/indicators/spec.py 확장 — PlotSpec{kind: line\ | done | 1728,1732,2924 |  |  | 5175a0ef |
| IND-16 | 지표 입력 소스로 다른 지표 출력 허용(indicator-on-indicator) — 레지스트리 의존 그래프·순환 탐지·loo | done | 2141,2930 |  | D2 | c486d2fb |
| CH-14 | chart-engine/src/panes/{paneModel,paneLayout,crosshairSync}.ts — KLine | done | 2454,3084,3092 |  | D3 | 59a8d852 |
| CH-15 | chart-engine/src/render/{plotRenderers,scaleBinding,fillBetween}.ts —  | done | 2436,3087,3101 |  | D3 | 59a8d852 |
| CH-16 | chart-engine/src/legend/{statusLine,dataWindow,objectTree}.ts — status | done | 3085,3092,3105 |  | D2 | 59a8d852 |
| CH-17 | 지표 템플릿(세트+설정+페인 배치) 저장·적용·공유 — backend charting 컨텍스트 확장 + 마켓 연동(MP 규칙  | done | 2664,3091,3627 |  | D2 | 2adf37a1 |
| CH-18 | chart-engine/src/compute/{workerPool,clientEngine,parityCheck}.ts — We | done | 2436,2454,2665 |  |  |  |
| CH-19 | 렌더 성능: 레이어 분리·뷰포트 밖 계산 생략·LOD 다운샘플링(극값 보존)·오프스크린 캔버스 + 밀도 벤치(CH-0 스크립트 | done | 2097,2436,2666 |  | D2 | 59a8d852 |
<!-- spec-status:end -->
