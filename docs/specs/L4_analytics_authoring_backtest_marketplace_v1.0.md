...
갱신 2026-09-16T17:30:45+00:00 · 총 107 · done 87 · inflight 3 · untouched 0 · hold 17 · 재오픈 8 · 깊이(done) {'D1': 1, 'D2': 27, 'D3': 19, 'D?': 40}
...
| DC-17 | application/realtime_fanout.py + 테스트 | done | 2330,2621,2895 |  |  | 0d604139 |
...
| IND-7g | reference/verify_all.py — 3자 교차검증: TA-Lib C 결과 ↔ 증분 엔진 ↔ 벡터 엔진을 같은 입력으 | done | 2326,2331,2927 | 2720 |  | 16e6496a |
...
| DSL-8 | runtime/series.py, runtime/interpreter.py + property 테스트 | done | 2917,3042,3049 |  |  | 7ff60745 |
...
| BT-9 | domain/reproducibility.py + test | done | 2152,3041,3047 |  |  | b3259127 |
...
| CH-0 | docs/design/CHART_ENGINE_FORK_EVAL.md + 벤치 스크립트 | done | 2666,3048,3068 |  | D2 | fd614b05 |
...
| IND-9 | docs/design/INDICATOR_OSS_EVAL.md — TA-Lib·pandas-ta·ta 라이선스 원문·종수·품질( | done | 2181,2919,3048 |  |  | 5d01c4eb |
| IND-11 | adapters/pandas_ta_bridge.py + 검증 — 대상 패키지 pandas-ta-classic(MIT, Pyth | done | 2658,2937 | 2720 |  |  |
| IND-12 | catalog/registry_tiers.py(코어/OSS/스크립트 3층, 이름 충돌·버전·해시 규칙) + GET /indic | done | 2926,3312,3399 | 2308 |  | a064c320 |
| IND-13 | 참조 벡터 대량 검증 잡(reference/verify_all.py, nightly) + CI 샘플링 | done | 2331,2933,2934 |  | D2 | 6e80c35b |
| IND-14 | 프론트 IndicatorPicker 확장(3층 탐색·검색·즐겨찾기·스크립트 지표 즉시 미리보기) | done | 1915,2454,2928 |  |  | 350fcc24 |
| BT-14 | docs/design/BACKTEST_VECTOR_EVAL.md — vectorbt OSS(Apache-2.0)·zipline | done | 2324,3048,3049 |  |  | fd614b05 |
| BT-15 | backtest/vector/{arrays,signals,fills}.py — numpy/numba 벡터화 엔진 코어(체결 모 | done | 3048,3049,3050 |  |  | fd614b05 |
...
| DSL-14 | script/import/pine/{lexer,parser}.py — Pine Script v5 부분 문법(입력·시리즈 연산· | done | 2307,2932 |  |  | 004c8ce0 |
...
| DC-21 | domain/point_in_time.py(FA-9 core/bitemporal.py 위임, 재구현 금지) + 참조 데이터 k | done | 2130,2892 |  | D3 | b82279eb |
