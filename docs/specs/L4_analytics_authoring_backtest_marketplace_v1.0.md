...
갱신 2026-09-23T17:02:31+00:00 · 총 107 · done 89 · inflight 1 · untouched 0 · hold 17 · 재오픈 0 · 깊이(done) {'D1': 1, 'D2': 33, 'D3': 19, 'D?': 36}
...
| IND-1 | engine/incremental.py + engine/vectorized.py 동일성 property 테스트 | done | 2920,5600,5649 |  |  |  |
...
| DSL-8 | runtime/series.py, runtime/interpreter.py + property 테스트 | done | 3042,3049,4146 |  |  | 6db8624b |
...
| DSL-12 | artifact/hash.py + POST /scripts/compile API + 오류 위치 응답 | done | 2918,3041,3042 |  | D2 | 926de736 |
...
| BT-2 | domain/fill/{slippage,commission,latency,partial_fill,order_types}.py  | done | 3041,3049,3050 |  | D2 | 4a90abc8 |
...
| BT-12 | application/tearsheet.py + performance 계약 재사용 | done | 2159,3054,3884 |  |  | cd9fbde2 |
...
| IND-11 | adapters/pandas_ta_bridge.py + 검증 — 대상 패키지 pandas-ta-classic(MIT, Pyth | done | 4035,4036,4037 |  |  | be9d98fe |
...
| BT-15 | backtest/vector/{arrays,signals,fills}.py — numpy/numba 벡터화 엔진 코어(체결 모 | done | 3048,3049,3050 |  | D2 | fd614b05 |
| BT-16 | backtest/vector/{grid,walk_forward,monte_carlo}.py — 파라미터 그리드·워크포워드·Mo | done | 2660,3053,3055 |  |  | 072b7d75 |
...
| CH-18 | chart-engine/src/compute/{workerPool,clientEngine,parityCheck}.ts — We | done | 2436,2454,2665 |  |  | 59a8d852 |
