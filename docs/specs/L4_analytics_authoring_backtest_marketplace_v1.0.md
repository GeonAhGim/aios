...
갱신 2026-09-15T17:30:22+00:00 · 총 107 · done 86 · inflight 4 · untouched 0 · hold 17 · 재오픈 57 · 깊이(done) {'D1': 1, 'D2': 14, 'D3': 3, 'D?': 68}
...
| DC-1 | contracts/v2/instruments.py + 스냅샷 | done | 2071,2874,2881 | 2889,2890 |  | 3388e1b7 |
| DC-2 | domain/instruments/symbol_master.py + test | done | 1124,2876 |  |  | b55fff83 |
| DC-3 | domain/instruments/lifecycle.py + test | done | 1125,2875 | 3533 |  | 6bbf82b2 |
| DC-4 | 마이그레이션 instruments/venue_listings(EXCLUDE) + 통합 테스트 | done | 2884,2892,3555 | 3556 |  | c77e0019 |
| DC-5 | ports/provider.py, ports/instrument_repository.py, ports/coverage_repo | done | 2883,2884,2885 | 2552 |  | 8bf909ed |
| DC-6 | domain/coverage/registry.py + test | done | 2882,2884,3559 | 3560 |  | 43391d79 |
| DC-7 | domain/coverage/gaps.py + test | done | 2882,2898,2991 |  |  | 8f8409dd |
...
| DC-15 | adapters/storage/tiering.py + 잡 테스트 | done | 2350,2897 |  |  | c37bc444 |
...
| DSL-9 | runtime/builtins_ta.py, builtins_math.py, builtins_strategy.py + test | done | 2140,2182,2929 | 2308 |  | 6dd612d9 |
| DSL-10 | compat/cond_v2_bridge.py + 전 케이스 왕복 테스트 + compat_map 저장 | done | 1555,2182 | 2921 |  | b404e37e |
| DSL-11 | src/core/strategy/script_facade.py + 회귀 테스트 | done | 2182,2521,2931 | 3216 |  | dae267d8 |
...
| CH-0 | docs/design/CHART_ENGINE_FORK_EVAL.md + 벤치 스크립트 | done | 2181,2666,3068 | 3048 |  | b690db23 |
...
| MP-3 | domain/versioning.py + test | hold | 2373,2935 |  |  | b71722f7 |
...
| IND-13 | 참조 벡터 대량 검증 잡(reference/verify_all.py, nightly) + CI 샘플링 | done | 2331,2933,2934 |  |  | 6e80c35b |
...
| IND-16 | 지표 입력 소스로 다른 지표 출력 허용(indicator-on-indicator) — 레지스트리 의존 그래프·순환 탐지·loo | done | 2141,2930 |  |  | c486d2fb |
| CH-14 | chart-engine/src/panes/{paneModel,paneLayout,crosshairSync}.ts — KLine | done | 2454,3084,3092 | 2436 | D3 | ee0cdbbe |
| CH-15 | chart-engine/src/render/{plotRenderers,scaleBinding,fillBetween}.ts —  | done | 2127,3087,3101 | 2436 | D3 | c20cb1e0 |
| CH-16 | chart-engine/src/legend/{statusLine,dataWindow,objectTree}.ts — status | done | 3085,3092,3105 | 2436 | D2 | 84c94866 |
| CH-17 | 지표 템플릿(세트+설정+페인 배치) 저장·적용·공유 — backend charting 컨텍스트 확장 + 마켓 연동(MP 규칙  | done | 2027,2664,3091 | 2436,3627 | D2 | f82a4042 |
| CH-18 | chart-engine/src/compute/{workerPool,clientEngine,parityCheck}.ts — We | done | 2098,2454,2665 | 2436 |  |  |
| CH-19 | 렌더 성능: 레이어 분리·뷰포트 밖 계산 생략·LOD 다운샘플링(극값 보존)·오프스크린 캔버스 + 밀도 벤치(CH-0 스크립트 | done | 2089,2097,2666 | 2436 |  | b690db23 |
<!-- spec-status:end -->
