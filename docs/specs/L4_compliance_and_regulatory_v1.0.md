...
갱신 2026-09-15T10:18:54+00:00 · 총 20 · done 15 · inflight 4 · untouched 0 · hold 1 · 재오픈 4 · 깊이(done) {'D2': 3, 'D3': 8, 'D?': 4}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| CM-1 | 기존 mandates/contracts/v1.py 확장(ComplianceDecision은 기존 policy_decision에 | done | 2118,2854,3625 |  | D3 | 2be7cca3 |
...
| CM-16 | reporting/ports/report_submitter.py + application/generate_report.py + | done | 2620 | 2618,2668 |  | b4c1037a |
