...
갱신 2026-09-24T17:13:11+00:00 · 총 20 · done 19 · inflight 0 · untouched 0 · hold 1 · 재오픈 0 · 깊이(done) {'D2': 6, 'D3': 12, 'D?': 1}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| CM-1 | 기존 mandates/contracts/v1.py 확장(ComplianceDecision은 기존 policy_decision에 | done | 3635,4916,4917 |  | D3 | d9da4a52 |
| CM-2 | 기존 MandateRuleInput에 제약 확장(자산군·국가·통화·유동성·ESG 배제) + mandates/domain/rul | done | 2036,2855 |  | D3 | 10468248 |
| CM-3 | domain/rule_bundle.py + domain/evaluator.py + test | done | 3635,4916,4917 |  | D3 | d9da4a52 |
| CM-4 | 기존 policy_bundle·policy_decision에 부족분만 추가(WORM 트리거 확인 포함) + 어댑터 확장 + 통 | done | 2857,2860,3023 |  | D2 | c6242a80 |
| CM-5 | 기존 mandates/application/{activate_revision,propose_amendment}를 규칙 번들 거 | done | 2862,3192,3992 |  | D3 | fe62a737 |
...
| CM-8 | application/evaluate_pre_trade.py + 주문 경로 배선(submit_order 시그니처 확장) + 적 | done | 2121,3126,3986 |  | D3 | 089fed75 |
| CM-9 | domain/rules/{short_sale,wash_trade}.py + test | done | 2458,2863,3849 |  | D3 | a8a1ce7a |
| CM-10 | domain/market_abuse.py + test | done | 2460,2864 |  | D3 | 90b124a8 |
| CM-11 | application/evaluate_post_trade.py + 배치 스케줄 + 통합 | done | 2509,2616,2865 |  | D3 | ffd5586b |
| CM-12 | 위반 알림·차단 해제 워크플로 + 통합 | done | 2667 |  | D2 | 359cf282 |
| CM-13 | application/explain.py + 재현 테스트 | done | 3843,3853,6032 |  | D3 | 705d56c3 |
| CM-14 | reporting/domain/best_execution.py + test | done | 2526,2867 |  | D2 | cd1a00de |
| CM-15 | reporting/domain/trade_report.py + test | done | 2617 |  | D2 | 37b17a2a |
| CM-16 | reporting/ports/report_submitter.py + application/generate_report.py + | done | 2620,2668,3636 |  | D3 | 8cd7cfe5 |
| CM-17 | src/api/routers/compliance.py + 통합·교차 테넌트 | done | 3853,6032,6320 |  |  | 0bc1d751 |
| CM-18 | 프론트 CompliancePage.tsx(판정 조회·규칙 히트·예외 승인) | done | 2668,5996 |  | D2 | 11e76988 |
| CM-19 | 프론트 MandatePage.tsx(위임장 편집·승인 흐름) | hold | 5996,6320 |  |  | 0bc1d751 |
| CM-20 | 적대적 스위트 tests/adversarial/compliance/(우회·변조·권위 분리) | done | 2619 |  | D2 | 6545dd41 |
<!-- spec-status:end -->
