...
갱신 2026-09-22T11:11:33+00:00 · 총 20 · done 19 · inflight 0 · untouched 0 · hold 1 · 재오픈 2 · 깊이(done) {'D2': 6, 'D3': 12, 'D?': 1}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| CM-1 | 기존 mandates/contracts/v1.py 확장(ComplianceDecision은 기존 policy_decision에 | done | 3625,3635,4916 | 4917 | D3 |  |
| CM-2 | 기존 MandateRuleInput에 제약 확장(자산군·국가·통화·유동성·ESG 배제) + mandates/domain/rul | done | 2036,2855 |  | D3 | 10468248 |
| CM-3 | domain/rule_bundle.py + domain/evaluator.py + test | done | 2856,3635,4916 | 4917 | D3 |  |
