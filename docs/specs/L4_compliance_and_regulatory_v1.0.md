...
갱신 2026-09-16T17:30:45+00:00 · 총 20 · done 19 · inflight 0 · untouched 0 · hold 1 · 재오픈 2 · 깊이(done) {'D2': 6, 'D3': 12, 'D?': 1}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| CM-1 | 기존 mandates/contracts/v1.py 확장(ComplianceDecision은 기존 policy_decision에 | done | 2854,3625,3635 |  | D3 | 2be7cca3 |
| CM-2 | 기존 MandateRuleInput에 제약 확장(자산군·국가·통화·유동성·ESG 배제) + mandates/domain/rul | done | 2036,2855 |  | D3 | 10468248 |
| CM-3 | domain/rule_bundle.py + domain/evaluator.py + test | done | 2066,2856,3635 |  | D3 | 2be7cca3 |
| CM-4 | 기존 policy_bundle·policy_decision에 부족분만 추가(WORM 트리거 확인 포함) + 어댑터 확장 + 통 | done | 2857,2860,3023 |  | D2 | c6242a80 |
| CM-5 | 기존 mandates/application/{activate_revision,propose_amendment}를 규칙 번들 거 | done | 2118,2853,2862 | 3192 | D3 | 70509c75 |
...
| CM-8 | application/evaluate_pre_trade.py + 주문 경로 배선(submit_order 시그니처 확장) + 적 | done | 2105,2121,3126 | 3986 | D3 | 60ba097f |
...
| CM-13 | application/explain.py + 재현 테스트 | done | 2866,3843,3853 |  | D3 | fb3d580c |
...
| CM-17 | src/api/routers/compliance.py + 통합·교차 테넌트 | done | 2620,3843,3853 |  |  | fb3d580c |
| CM-18 | 프론트 CompliancePage.tsx(판정 조회·규칙 히트·예외 승인) | done | 2668 |  | D2 | 6760170d |
