...
갱신 2026-09-10T08:25:00+00:00 · 총 20 · done 13 · inflight 6 · untouched 0 · hold 1 · 재오픈 3 · 깊이(done) {'D2': 2, 'D3': 5, 'D?': 6}
...
| CM-4 | 기존 policy_bundle·policy_decision에 부족분만 추가(WORM 트리거 확인 포함) + 어댑터 확장 + 통 | done | 2857,2860,3023 |  |  | c6242a80 |
| CM-5 | 기존 mandates/application/{activate_revision,propose_amendment}를 규칙 번들 거 | done | 2118,2853,2862 | 3192 |  | 70509c75 |
| CM-6 | domain/rules/{restricted_list,concentration}.py + test | done | 2065,2105,2858 |  |  | c0a3f971 |
| CM-7 | domain/rules/{leverage,liquidity,position_limit}.py + test | done | 2066,2105,2859 |  | D2 | b00478bf |
| CM-8 | application/evaluate_pre_trade.py + 주문 경로 배선(submit_order 시그니처 확장) + 적 | done | 2105,2121 | 3126 |  | f553385a |
...
| CM-14 | reporting/domain/best_execution.py + test | done | 2526,2867 |  |  | cd1a00de |
