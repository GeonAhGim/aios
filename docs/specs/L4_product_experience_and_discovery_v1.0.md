...
갱신 2026-09-24T17:13:11+00:00 · 총 22 · done 22 · inflight 0 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 15, 'D?': 7}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| UX-1 | i18n 프레임워크 도입 + catalog.ko 골격 + 포매터(금액 Decimal 유지) + ESLint 리터럴 금지 규칙 | done | 2685,2845 |  | D2 | a266916a |
| UX-2 | 기존 147개 파일 문자열 키 추출·치환(기계적 변환 + 수동 검수) + catalog.en 초벌 | done | 2686,6524 |  | D2 | 9557fa09 |
| UX-3 | 디자인 토큰 + 다크 모드 + 공용 컴포넌트 계약 | done | 2687 |  | D2 | 157d6324 |
| UX-4 | 접근성 baseline(포커스·레이블·대비) + CI 검사(axe) | done | 2688 |  |  | a4cf25a2 |
| UX-5 | screener/contracts/v1.py + domain/query_plan.py + test | done | 2689 |  |  | 9cf7aa5f |
| UX-6 | application/run_screen.py + 인덱스·캐시 + 통합 | done | 2690 |  | D2 | 00f2dbd1 |
| UX-7 | save/share/alert_on_screen + 마이그레이션 + 통합 | done | 2691 |  | D2 | 54a07fd8 |
| UX-8 | 프론트 ScreenerPage.tsx(필터 빌더·결과 표·차트/백테스트 연결) | done | 2692,6524 |  | D2 | 9557fa09 |
| UX-9 | whatif/domain/impact.py + test | done | 2693,4060 |  | D2 | 1f262542 |
| UX-10 | whatif/application/preview_order.py + 쓰기 0 정적 검사 + 적대적 | done | 2694 |  |  | 46d57006 |
| UX-11 | whatif/application/rebalance_plan.py + core/portfolio 연결 + test | done | 2695,4017 |  |  | b4897f06 |
| UX-12 | 프론트 WhatIfPanel.tsx + RebalancePage.tsx | done | 2696 |  |  | 8c274d4c |
| UX-13 | follow/contracts/v1.py + domain/mirror_rules.py + test | done | 2697 |  |  |  |
| UX-14 | follow/application/mirror_signal.py + 게이트 통과 적대적 테스트 | done | 2698 |  |  | fc8e37ed |
| UX-15 | 프론트 FollowPage.tsx(팔로우 관리·성과 비교) + 자문 오인 표현 금지 검수 | done | 2699 |  | D2 | c3e62ed0 |
| UX-16 | PWA(매니페스트·서비스워커·설치) + 오프라인 셸 | done | 2700 |  | D2 | dafc1798 |
| UX-17 | 푸시 알림 연동(device_tokens) + 권한 흐름 | done | 2701 |  | D2 | 49b55d5b |
| UX-18 | 알림 센터 + 일간 다이제스트(이메일·푸시) | done | 2702 |  | D2 | 16b6b55f |
| UX-19 | 명령 팔레트 + 단축키 맵 + 도움말 | done | 2703 |  | D2 | a5d0dd58 |
| UX-20 | 온보딩 흐름(거래소 연결 → 전략 → 페이퍼 실행) + 전 목록 빈 상태 | done | 2704 |  | D2 | 9ec81644 |
| UX-21 | 반응형 브레이크포인트 전 화면 점검 + 모바일 레이아웃 회귀 | done | 2705 |  | D2 | dbcd89f6 |
| UX-22 | 결정 이력 뷰어 — 주문·판정·데이터 계보를 이벤트에서 역추적해 표시 | done | 2706 |  | D2 | f3ef870a |
<!-- spec-status:end -->
