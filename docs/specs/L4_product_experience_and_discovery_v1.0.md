...
갱신 2026-09-23T17:02:31+00:00 · 총 22 · done 22 · inflight 0 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D2': 15, 'D?': 7}
...
| UX-2 | 기존 147개 파일 문자열 키 추출·치환(기계적 변환 + 수동 검수) + catalog.en 초벌 | done | 2686 |  | D2 | 8db06f6c |
...
| UX-8 | 프론트 ScreenerPage.tsx(필터 빌더·결과 표·차트/백테스트 연결) | done | 2692 |  | D2 | 4bba9562 |
