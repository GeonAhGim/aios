...
갱신 2026-09-15T17:30:22+00:00 · 총 22 · done 4 · inflight 18 · untouched 0 · hold 0 · 재오픈 0 · 깊이(done) {'D?': 4}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| UX-1 | i18n 프레임워크 도입 + catalog.ko 골격 + 포매터(금액 Decimal 유지) + ESLint 리터럴 금지 규칙 | done | 2685,2845 |  |  | a266916a |
...
| UX-15 | 프론트 FollowPage.tsx(팔로우 관리·성과 비교) + 자문 오인 표현 금지 검수 | done | 2699 |  |  | c3e62ed0 |
| UX-16 | PWA(매니페스트·서비스워커·설치) + 오프라인 셸 | done | 2700 |  |  | dafc1798 |
| UX-17 | 푸시 알림 연동(device_tokens) + 권한 흐름 | done | 2701 |  |  | 49b55d5b |
