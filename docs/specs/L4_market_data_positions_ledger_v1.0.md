...
갱신 2026-09-15T10:18:54+00:00 · 총 63 · done 63 · inflight 0 · untouched 0 · hold 0 · 재오픈 32 · 깊이(done) {'D2': 3, 'D?': 60}
...
| LA-2 | domain/timeframe.py + test | done | 379,2131,3579 | 2891,2946 |  |  |
...
| LA-11 | 마이그레이션 4a1d0c0de003_md_candles.py: md_candle RANGE 파티션(open_time, 월) P | done | 450,1212,2966 | 2886 |  | cd8cc18f |
| LA-12 | adapters/postgres_reference_repository.py, adapters/postgres_calendar_ | done | 451,645,2967 |  |  | 84688857 |
...
| LA-19 | src/exchanges/{bitget,kis}/market_data_mixin.py 심볼 변환 → normalizer 위임  | done | 488,2963 |  |  | 022204c3 |
| LA-20 | adapters/kis_ingest_source.py + test(MockTransport) | done | 713 | 2979 |  | e52a183 |
| LA-21 | adversarial 2파일 + perf 리플레이 | done | 655,2984 | 3328 |  | 283af528 |
| LA-24 | src/api/routers/market_data.py + src/api/schemas/market_data.py + test | done | 2168,2195,2996 | 2994,3001 |  | f0c59584 |
...
| LB-18 | adversarial 2파일 + perf | done | 489,2970 |  |  | 0d8613bd |
...
| LC-6 | 마이그레이션 4a1d0c0de005_ledger_core.py: ledger_account(account_id UUID PK, | done | 3538,3539,3545 |  |  | cd148b67 |
...
| LC-16 | application/queries.py + src/api/routers/wallet.py 수정(GET /wallet이 ava | done | 951,2969,2973 | 2989 |  | ef5f4881 |
