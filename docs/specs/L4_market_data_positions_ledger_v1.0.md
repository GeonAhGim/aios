...
갱신 2026-09-22T17:04:05+00:00 · 총 63 · done 63 · inflight 0 · untouched 0 · hold 0 · 재오픈 6 · 깊이(done) {'D2': 5, 'D3': 5, 'D?': 53}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| L0-1 | src/core/observability/metrics_registry.py + tests/unit/core/test_metr | done | 129,4197 |  |  | 53d8e07 |
| L0-2 | tests/unit/test_zone_purity.py + ruff banned-api 설정(pyproject) | done | 1124,2876,4096 | 4910,4911 |  | 8dc77eea |
| L0-3 | src/core/db/append_only.py, src/core/db/roles.py + tests/unit/core/tes | done | 130,328,4199 |  |  | effd51e0 |
| L0-4 | src/foundation/evidence/adapters/postgres_repository.py 기존-수정: append_ | done | 131,3320,4095 |  |  | d40c5450 |
| L0-5 | src/db/migrations/versions/4a1d0c0de001_db_roles_and_worm_helper.py +  | done | 307,328,3335 |  |  | 2e0488f |
| LA-1 | market_data/contracts/v1.py + test_contracts_schema.py | done | 378 |  |  | de7f42d |
| LA-2 | domain/timeframe.py + test | done | 2891,2946,3579 | 4928 |  | c1a7ffba |
| LA-3 | domain/calendar/session_rules.py, domain/calendar/known_venues.py + te | done | 2554,2900,2947 | 4926,4927 |  | 001aea76 |
| LA-4 | domain/quality/ohlc_sanity.py, dedupe.py + tests | done | 2948,4105,4106 |  |  | 0a09938 |
| LA-5 | domain/quality/gap_detector.py, stale_detector.py + tests | done | 2952,2991,4111 |  |  | d0a7c3d4 |
| LA-6 | domain/quality/outlier_detector.py, verdict.py + tests | done | 2950,4107,4108 |  | D2 | 111d9185 |
| LA-7 | domain/reference/symbol_normalizer.py, lifecycle.py + tests | done | 391,2951,4109 |  |  | 052d7561 |
| LA-8 | domain/corporate_actions/adjustment.py, domain/lineage.py + tests | done | 1111,2954,4112 |  |  | da4690c3 |
| LA-9 | ports/.py 5파일 | done | 825,2955,4113 |  |  | cdc91c99 |
| LA-10 | 마이그레이션 4a1d0c0de002_md_reference_registry.py: md_instrument(UNIQUE(ven | done | 418,2964 |  |  | 69095696 |
| LA-11 | 마이그레이션 4a1d0c0de003_md_candles.py: md_candle RANGE 파티션(open_time, 월) P | done | 1212,2886,2966 |  |  | 823a0db3 |
| LA-12 | adapters/postgres_reference_repository.py, adapters/postgres_calendar_ | done | 451,645,2967 |  | D3 | 84688857 |
| LA-13 | adapters/postgres_candle_store.py, adapters/postgres_batch_repository. | done | 825,2968,4122 |  |  | 68735418 |
| LA-14 | application/register_instrument.py, record_corporate_action.py, sync_c | done | 616,2971,3340 |  |  | 4d28dd2d |
| LA-15 | application/ingest_candles.py, adapters/bitget_ingest_source.py + test | done | 623,2976 |  |  | e17161f2 |
| LA-16 | application/ingest_ticks.py + test | done | 656,842,1321 |  |  | a15a171 |
| LA-17 | application/get_candles.py, replay_candles.py + tests | done | 624,826,2972 |  |  | 88205564 |
| LA-18 | application/quality_metrics.py + scheduler.py + main.py 배선(백그라운드 태스크,  | done | 712,2981 |  |  | b657cca4 |
| LA-19 | src/exchanges/{bitget,kis}/market_data_mixin.py 심볼 변환 → normalizer 위임  | done | 488,2963 |  | D3 | 022204c3 |
| LA-20 | adapters/kis_ingest_source.py + test(MockTransport) | done | 713,2979 | 4912,4913 |  | 8b4e556a |
| LA-21 | adversarial 2파일 + perf 리플레이 | done | 3328,4123,4124 | 5273 |  | 9c57bcf1 |
| LA-24 | src/api/routers/market_data.py + src/api/schemas/market_data.py + test | done | 2996,3001,4143 |  |  | 8833db84 |
| LB-1 | positions/contracts/v1.py + schema test | done | 336 |  |  | 7c84847 |
| LB-2 | domain/position_key.py, domain/cost_basis/fifo.py + tests | done | 350,1985 |  |  | 80ac8c2 |
| LB-3 | domain/cost_basis/weighted.py, selector.py + tests | done | 361,4100,4101 |  |  | 5fe3acba |
| LB-4 | domain/fx.py, domain/pnl.py, domain/funding_fees.py + tests | done | 3327,3442,4098 |  |  | 369984c6 |
| LB-5 | domain/journal_rules.py, domain/snapshot_builder.py + tests(property) | done | 2050,2058,2944 |  | D2 | 62884739 |
| LB-6 | domain/nav.py, domain/reconciliation_rules.py + tests | done | 362 |  |  | b2df4c6 |
| LB-7 | ports/.py 6파일 | done | 355,4099 |  |  | 58825d69 |
| LB-8 | 마이그레이션 4a1d0c0de004_positions_journal.py: pos_account(PK, tenant_id FK | done | 356 |  |  | c8ce97b |
| LB-9 | adapters/postgres_journal_repository.py, postgres_snapshot_repository. | done | 2945,4102,4103 |  | D2 | 9fb1e837 |
| LB-10 | adapters/legacy_positions_projection.py + test_legacy_compat.py | done | 376,2949,4104 |  |  | bd1f4873 |
| LB-11 | application/record_fill.py + integration test | done | 412,822,2956 |  |  | 72c098cf |
| LB-12 | src/services/order_service/position_ledger.py 수정(위임) + 기존 tests/integr | done | 3339,3470,4115 |  | D3 | ed5f6012 |
| LB-13 | application/record_funding_fee.py, rebuild_snapshot.py + tests | done | 452,2958,4116 |  | D3 | 761e4e17 |
| LB-14 | adapters/candle_mark_price_source.py, fx_rate_source.py, application/m | done | 654,2977 |  |  | 97958c6e |
| LB-15 | application/compute_daily_nav.py + test | done | 714,2980 |  |  | ee390103 |
| LB-16 | adapters/exchange_balance_source.py, application/reconcile_provider.py | done | 726,2982,4125 |  |  | ef2b9581 |
| LB-17 | application/queries.py, scheduler.py + main.py 배선 + test | done | 1377,2983,3332 |  |  | 84077012 |
| LB-18 | adversarial 2파일 + perf | done | 489,2970,4121 |  |  | f8c7034f |
| LB-19 | src/api/routers/positions.py + src/api/schemas/positions.py + tests/in | done | 2993,2995,4144 |  |  | 201a4cfb |
| LC-1 | ledger/contracts/v1.py + schema test | done | 213 |  |  | 60af4b5 |
| LC-2 | domain/chart_of_accounts.py, domain/rounding.py + tests; src/services/ | done | 214,4097 |  |  | b44d62c0 |
| LC-3 | domain/balance_rules.py, domain/hash_chain.py, domain/idempotency.py + | done | 215,2050,2058 |  | D2 | aebf10d5 |
| LC-4 | domain/posting_rules.py + test_posting_rules.py | done | 308,2058 |  | D2 | aebf10d5 |
| LC-5 | domain/hold_state.py, domain/payout_schedule.py, domain/trial_balance. | done | 310 |  |  | 3a99c22 |
| LC-6 | 마이그레이션 4a1d0c0de005_ledger_core.py: ledger_account(account_id UUID PK, | done | 3736,3749,3801 |  | D3 | cd148b67 |
| LC-7 | 마이그레이션 4a1d0c0de006_ledger_holds_payouts.py: ledger_hold(UNIQUE(purpos | done | 318 |  |  | 90d3c3e |
| LC-8 | ports/.py 4파일 + adapters/postgres_journal_repository.py, postgres_bala | done | 319,320 |  |  | 21bdbbb |
| LC-9 | application/post_entry.py + test_post_entry.py | done | 701,2978,3320 |  |  | 2058b852 |
| LC-10 | application/verify_integrity.py + scheduler.py(무결성 부분) + test | done | 420,920,2957 |  |  | bf513da8 |
| LC-11 | scripts/ledger_backfill.py + application/backfill.py + test_backfill.p | done | 349,2943 |  |  | 69986631 |
| LC-12 | adapters/legacy_wallet_bridge.py + src/services/wallet_service.py 수정 + | done | 363,2953 |  |  | 203f1060 |
| LC-13 | adapters/postgres_hold_repository.py, application/purchase_flow.py + s | done | 424,2960 | 4918,4920 |  | 8006c735 |
| LC-14 | application/refund.py + src/services/dispute_resolution_service.py 수정  | done | 453,2962 |  |  | 83bcd968 |
| LC-15 | adapters/postgres_payout_repository.py, application/payouts.py, applic | done | 486,487 |  |  | 0efd6c2 |
| LC-16 | application/queries.py + src/api/routers/wallet.py 수정(GET /wallet이 ava | done | 2969,2973,2989 |  |  | dc2d1597 |
| LC-17 | adversarial 4파일 + perf | done | 1038,2974,2975 |  |  | 78b00a3d |
<!-- spec-status:end -->
