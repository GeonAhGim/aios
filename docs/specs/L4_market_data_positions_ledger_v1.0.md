...
갱신 2026-09-16T17:30:45+00:00 · 총 63 · done 63 · inflight 0 · untouched 0 · hold 0 · 재오픈 2 · 깊이(done) {'D2': 4, 'D3': 5, 'D?': 54}
...
| L0-2 | tests/unit/test_zone_purity.py + ruff banned-api 설정(pyproject) | done | 166,1124,2876 |  |  | b55fff83 |
...
| LA-4 | domain/quality/ohlc_sanity.py, dedupe.py + tests | done | 381,2948 |  |  | a6c887e4 |
| LA-5 | domain/quality/gap_detector.py, stale_detector.py + tests | done | 2882,2952,2991 |  |  | 8f8409dd |
| LA-6 | domain/quality/outlier_detector.py, verdict.py + tests | done | 390,2950 |  | D2 | 751a8c22 |
| LA-7 | domain/reference/symbol_normalizer.py, lifecycle.py + tests | done | 391,2951 |  |  | f4b5e679 |
| LA-8 | domain/corporate_actions/adjustment.py, domain/lineage.py + tests | done | 411,1111,2954 |  |  | 1edf98f7 |
| LA-9 | ports/.py 5파일 | done | 417,825,2955 |  |  | 2554e12c |
...
| LA-13 | adapters/postgres_candle_store.py, adapters/postgres_batch_repository. | done | 615,825,2968 |  |  | 1dc68200 |
...
| LA-24 | src/api/routers/market_data.py + src/api/schemas/market_data.py + test | done | 2994,2996,3001 |  |  | 9585c8c2 |
...
| LB-9 | adapters/postgres_journal_repository.py, postgres_snapshot_repository. | done | 375,2945 |  |  | 184b5ec0 |
| LB-10 | adapters/legacy_positions_projection.py + test_legacy_compat.py | done | 376,2949 |  |  | 2e89533e |
| LB-11 | application/record_fill.py + integration test | done | 412,822,2956 |  |  | 72c098cf |
| LB-12 | src/services/order_service/position_ledger.py 수정(위임) + 기존 tests/integr | done | 2959,3339,3470 |  | D3 | ce2ce8ce |
| LB-13 | application/record_funding_fee.py, rebuild_snapshot.py + tests | done | 452,2958 |  | D3 | f80af78e |
...
| LB-16 | adapters/exchange_balance_source.py, application/reconcile_provider.py | done | 726,2982 |  |  | 7748940f |
...
| LB-19 | src/api/routers/positions.py + src/api/schemas/positions.py + tests/in | done | 2467,2993,2995 |  |  | a3cb1050 |
