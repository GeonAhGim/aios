...
갱신 2026-09-12T17:04:32+00:00 · 총 63 · done 63 · inflight 0 · untouched 0 · hold 0 · 재오픈 42 · 깊이(done) {'D2': 3, 'D?': 60}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| L0-1 | src/core/observability/metrics_registry.py + tests/unit/core/test_metr | done | 129 |  |  | 53d8e07 |
| L0-2 | tests/unit/test_zone_purity.py + ruff banned-api 설정(pyproject) | done | 166,1124 | 2876 |  | 7ffefc0 |
| L0-3 | src/core/db/append_only.py, src/core/db/roles.py + tests/unit/core/tes | done | 130,328 |  |  | 675f786 |
| L0-4 | src/foundation/evidence/adapters/postgres_repository.py 기존-수정: append_ | done | 131,3320 |  |  | 63829f6 |
...
| LA-2 | domain/timeframe.py + test | done | 379,2131 | 2891,2946 |  | f702898b |
| LA-3 | domain/calendar/session_rules.py, domain/calendar/known_venues.py + te | done | 380,2554,2900 | 2947 |  | 0126c979 |
| LA-4 | domain/quality/ohlc_sanity.py, dedupe.py + tests | done | 381 | 2948 |  | bdb09a0 |
| LA-5 | domain/quality/gap_detector.py, stale_detector.py + tests | done | 410,1178 | 2882,2952,2991 |  | b1dbedc |
| LA-6 | domain/quality/outlier_detector.py, verdict.py + tests | done | 390 | 2950 |  | 5616181 |
| LA-7 | domain/reference/symbol_normalizer.py, lifecycle.py + tests | done | 391 | 2951 |  | 584c94c |
| LA-8 | domain/corporate_actions/adjustment.py, domain/lineage.py + tests | done | 411,1111 | 2954 |  | 9dcb231 |
| LA-9 | ports/.py 5파일 | done | 417,825 | 2955 |  | 190dfea |
| LA-10 | 마이그레이션 4a1d0c0de002_md_reference_registry.py: md_instrument(UNIQUE(ven | done | 418 | 2964 |  | 10abb56 |
| LA-11 | 마이그레이션 4a1d0c0de003_md_candles.py: md_candle RANGE 파티션(open_time, 월) P | done | 450,1212 | 2886,2966 |  | 0b17502 |
| LA-12 | adapters/postgres_reference_repository.py, adapters/postgres_calendar_ | done | 451,645 | 2967 |  | 1c9f288 |
| LA-13 | adapters/postgres_candle_store.py, adapters/postgres_batch_repository. | done | 615,825 | 2968 |  | 190dfea |
| LA-14 | application/register_instrument.py, record_corporate_action.py, sync_c | done | 616,3340 | 2971 |  | 8487538 |
| LA-15 | application/ingest_candles.py, adapters/bitget_ingest_source.py + test | done | 623 | 2976 |  | fe9ea8f |
| LA-16 | application/ingest_ticks.py + test | done | 656,842,1321 |  |  | a15a171 |
| LA-17 | application/get_candles.py, replay_candles.py + tests | done | 624,826 | 2972 |  | 87094a1 |
| LA-18 | application/quality_metrics.py + scheduler.py + main.py 배선(백그라운드 태스크,  | done | 712 | 2981 |  | 5f0b61e |
| LA-19 | src/exchanges/{bitget,kis}/market_data_mixin.py 심볼 변환 → normalizer 위임  | done | 488 | 2963 |  | 0edadcb |
| LA-20 | adapters/kis_ingest_source.py + test(MockTransport) | done | 713 | 2979 |  | e52a183 |
| LA-21 | adversarial 2파일 + perf 리플레이 | done | 655 | 2984,3328 |  | 3844e83 |
| LA-24 | src/api/routers/market_data.py + src/api/schemas/market_data.py + test | done | 2168,2195,2996 | 2893,2994,3001 |  | f0c59584 |
...
| LB-3 | domain/cost_basis/weighted.py, selector.py + tests | done | 361 |  |  | 132700e |
| LB-4 | domain/fx.py, domain/pnl.py, domain/funding_fees.py + tests | done | 351,3327,3442 |  |  | 9093cbdb |
| LB-5 | domain/journal_rules.py, domain/snapshot_builder.py + tests(property) | done | 374,2050,2058 | 2944 | D2 | aebf10d5 |
| LB-6 | domain/nav.py, domain/reconciliation_rules.py + tests | done | 362 |  |  | b2df4c6 |
| LB-7 | ports/.py 6파일 | done | 355 |  |  | f6b749e |
| LB-8 | 마이그레이션 4a1d0c0de004_positions_journal.py: pos_account(PK, tenant_id FK | done | 356 |  |  | c8ce97b |
| LB-9 | adapters/postgres_journal_repository.py, postgres_snapshot_repository. | done | 375 | 2945 |  | e491f04 |
| LB-10 | adapters/legacy_positions_projection.py + test_legacy_compat.py | done | 376 | 2949 |  | 9e26cbf |
| LB-11 | application/record_fill.py + integration test | done | 412,822 | 2956 |  | 88932f9 |
| LB-12 | src/services/order_service/position_ledger.py 수정(위임) + 기존 tests/integr | done | 425,3339,3470 | 2959 |  | 5424d67 |
| LB-13 | application/record_funding_fee.py, rebuild_snapshot.py + tests | done | 452 | 2958 |  | 2c9bf78 |
| LB-14 | adapters/candle_mark_price_source.py, fx_rate_source.py, application/m | done | 654 | 2977 |  | 2df4ed7 |
| LB-15 | application/compute_daily_nav.py + test | done | 714 | 2980 |  | fc73e26 |
| LB-16 | adapters/exchange_balance_source.py, application/reconcile_provider.py | done | 726 | 2982 |  | f425070 |
| LB-17 | application/queries.py, scheduler.py + main.py 배선 + test | done | 727,1377 | 2983,3332 |  | 8407701 |
| LB-18 | adversarial 2파일 + perf | done | 489 | 2970 |  | fb24f04 |
| LB-19 | src/api/routers/positions.py + src/api/schemas/positions.py + tests/in | done | 2168,2467,2995 | 2993 |  | 296150e4 |
| LC-1 | ledger/contracts/v1.py + schema test | done | 213 |  |  | 60af4b5 |
| LC-2 | domain/chart_of_accounts.py, domain/rounding.py + tests; src/services/ | done | 214 |  |  | 92d1ef9 |
...
| LC-6 | 마이그레이션 4a1d0c0de005_ledger_core.py: ledger_account(account_id UUID PK, | done | 3537,3538,3539 | 3545 |  | cd148b67 |
...
| LC-9 | application/post_entry.py + test_post_entry.py | done | 330,701,3320 | 2978 |  | 63829f6 |
| LC-10 | application/verify_integrity.py + scheduler.py(무결성 부분) + test | done | 335,420,920 | 2957 |  | b5e9a92 |
| LC-11 | scripts/ledger_backfill.py + application/backfill.py + test_backfill.p | done | 349 | 2943 |  | fc08429 |
| LC-12 | adapters/legacy_wallet_bridge.py + src/services/wallet_service.py 수정 + | done | 363 | 2953 |  | 411a00a |
| LC-13 | adapters/postgres_hold_repository.py, application/purchase_flow.py + s | done | 424 | 2960 |  | ef6627b |
| LC-14 | application/refund.py + src/services/dispute_resolution_service.py 수정  | done | 453 | 2962 |  | ceccb89 |
| LC-15 | adapters/postgres_payout_repository.py, application/payouts.py, applic | done | 486,487 |  |  | 0efd6c2 |
| LC-16 | application/queries.py + src/api/routers/wallet.py 수정(GET /wallet이 ava | done | 618,951,2973 | 2969,2989 |  | b45d6e56 |
| LC-17 | adversarial 4파일 + perf | done | 626,627,1038 | 2974,2975 |  | 3ea1fc1 |
<!-- spec-status:end -->
