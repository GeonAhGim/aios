...
갱신 2026-09-23T10:42:28+00:00 · 총 63 · done 63 · inflight 0 · untouched 0 · hold 0 · 재오픈 1 · 깊이(done) {'D2': 10, 'D3': 8, 'D?': 45}
...
| L0-2 | tests/unit/test_zone_purity.py + ruff banned-api 설정(pyproject) | done | 4096,4910,4911 |  |  | 5d7e1376 |
...
| LA-2 | domain/timeframe.py + test | done | 2946,3579,4928 |  |  | 2984b706 |
| LA-3 | domain/calendar/session_rules.py, domain/calendar/known_venues.py + te | done | 2947,4926,4927 |  |  | 377aff38 |
...
| LA-7 | domain/reference/symbol_normalizer.py, lifecycle.py + tests | done | 391,2951,4109 |  | D2 | 052d7561 |
| LA-8 | domain/corporate_actions/adjustment.py, domain/lineage.py + tests | done | 1111,2954,4112 | 5317 |  | da4690c3 |
| LA-9 | ports/.py 5파일 | done | 825,2955,4113 |  | D2 | cdc91c99 |
...
| LA-20 | adapters/kis_ingest_source.py + test(MockTransport) | done | 2979,4912,4913 |  |  | a6fae35b |
| LA-21 | adversarial 2파일 + perf 리플레이 | done | 4123,4124,5273 |  |  |  |
...
| LB-3 | domain/cost_basis/weighted.py, selector.py + tests | done | 361,4100,4101 |  | D2 | 5fe3acba |
...
| LB-16 | adapters/exchange_balance_source.py, application/reconcile_provider.py | done | 726,2982,4125 |  | D3 | ef2b9581 |
| LB-17 | application/queries.py, scheduler.py + main.py 배선 + test | done | 1377,2983,3332 |  | D3 | 84077012 |
| LB-18 | adversarial 2파일 + perf | done | 489,2970,4121 |  | D2 | f8c7034f |
...
| LC-2 | domain/chart_of_accounts.py, domain/rounding.py + tests; src/services/ | done | 214,4097 |  | D2 | b44d62c0 |
...
| LC-9 | application/post_entry.py + test_post_entry.py | done | 701,2978,3320 |  |  | e894792 |
| LC-10 | application/verify_integrity.py + scheduler.py(무결성 부분) + test | done | 420,920,2957 |  |  | bf513da8 |
| LC-11 | scripts/ledger_backfill.py + application/backfill.py + test_backfill.p | done | 349,2943 |  | D3 | 69986631 |
| LC-12 | adapters/legacy_wallet_bridge.py + src/services/wallet_service.py 수정 + | done | 363,2953 |  |  | 203f1060 |
| LC-13 | adapters/postgres_hold_repository.py, application/purchase_flow.py + s | done | 2960,4918,4920 |  |  | 168b138d |
