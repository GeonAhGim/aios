...
갱신 2026-09-20T01:29:40+00:00 · 총 63 · done 63 · inflight 0 · untouched 0 · hold 0 · 재오픈 6 · 깊이(done) {'D2': 5, 'D3': 5, 'D?': 53}
...
| L0-2 | tests/unit/test_zone_purity.py + ruff banned-api 설정(pyproject) | done | 1124,2876,4096 |  |  | 8dc77eea |
| L0-3 | src/core/db/append_only.py, src/core/db/roles.py + tests/unit/core/tes | done | 130,328 | 4199 |  | 675f786 |
| L0-4 | src/foundation/evidence/adapters/postgres_repository.py 기존-수정: append_ | done | 131,3320 | 4095 |  | 63829f6 |
...
| LA-2 | domain/timeframe.py + test | done | 2891,2946,3579 |  |  | c1a7ffba |
| LA-3 | domain/calendar/session_rules.py, domain/calendar/known_venues.py + te | done | 2554,2900,2947 |  |  | 001aea76 |
...
| LA-20 | adapters/kis_ingest_source.py + test(MockTransport) | done | 713,2979 |  |  | 8b4e556a |
...
| LB-7 | ports/.py 6파일 | done | 355 | 4099 |  | f6b749e |
...
| LB-12 | src/services/order_service/position_ledger.py 수정(위임) + 기존 tests/integr | done | 2959,3339,3470 | 4115 | D3 | ce2ce8ce |
...
| LC-13 | adapters/postgres_hold_repository.py, application/purchase_flow.py + s | done | 424,2960 |  |  | 8006c735 |
