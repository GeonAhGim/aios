...
갱신 2026-09-17T17:31:56+00:00 · 총 42 · done 42 · inflight 0 · untouched 0 · hold 0 · 재오픈 7 · 깊이(done) {'D1': 2, 'D2': 10, 'D3': 3, 'D?': 27}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| PLT-1 | src/core/observability/context.py + tests/platform/unit/test_context.p | done | 461,816,3141 | 4126 |  | 95cd2c6c |
| PLT-2 | src/core/logging/redaction.py, fields.py + 단위 테스트 | done | 3297,3379,3919 |  | D3 | da1f6315 |
| PLT-3 | src/core/logging/schema.py 수정(fields 위임, QueueHandler) | done | 845,3145,4129 | 4200 |  | 9ed65e94 |
| PLT-4 | src/core/observability/metric_names.py, metrics.py + prometheus-client | done | 3335,3455,4118 | 4117 | D3 | 18c96af8 |
...
| PLT-8 | loop_health.py + base_loop.py 수정 + main.py 4루프·scheduler 계측(PM) | done | 938,3155 | 4455 |  | 62205370 |
...
| PLT-16 | src/api/versioning.py + scripts/export_openapi.py + contracts/openapi/ | done | 3151,3180,3193 |  |  | 4333920b |
| PLT-17 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 |  | D2 | dd3b0262 |
| PLT-18 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 |  | D2 | dd3b0262 |
| PLT-19 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 |  | D2 | dd3b0262 |
| PLT-20 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 |  | D2 | dd3b0262 |
| PLT-21 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 |  | D2 | dd3b0262 |
| PLT-22 | src/services/auth/lockout.py + auth_service.py 수정 + test_lockout_atomi | done | 1021,3148,3300 |  |  | d3f5e419 |
| PLT-23 | M3 auth_session + session_repository.py + tokens.py | done | 1166,1380,3162 | 4134 |  | 22139c50 |
| PLT-24 | auth/login.py, refresh.py, logout.py + routers/auth.py·deps.py 수정 | done | 3184,3310,3398 |  |  | ba5ad7e3 |
| PLT-25 | rate_limit/policy.py, limiter.py, api/middleware/rate_limit.py + main. | done | 1021,3153,3321 | 4130 | D2 | 1dba9de4 |
...
| PLT-32 | envelope.py(봉투 암호화), secret_ref.py, secret_handle.py | done | 932,3152 | 3904 |  |  |
