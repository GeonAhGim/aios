...
갱신 2026-09-15T17:30:22+00:00 · 총 42 · done 40 · inflight 2 · untouched 0 · hold 0 · 재오픈 37 · 깊이(done) {'D1': 2, 'D2': 2, 'D3': 3, 'D?': 33}
...
| PLT-15 | 금전 라우트 이관 6곳(marketplace purchase, admin confirm-payment, wallet, exec | done | 3139,3185,3186 |  |  | 4aaa8228 |
...
| PLT-24 | auth/login.py, refresh.py, logout.py + routers/auth.py·deps.py 수정 | done | 3184,3310,3398 | 3170 |  | 50098920 |
| PLT-25 | rate_limit/policy.py, limiter.py, api/middleware/rate_limit.py + main. | done | 853,1021,3321 | 3153 | D2 | 7e37a077 |
...
| PLT-37 | scripts/coverage_ratchet.py + coverage-baseline.txt + CI 스텝 | done | 1240,2176,3182 | 3154 |  | d3d126e1 |
