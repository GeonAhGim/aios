...
갱신 2026-09-16T17:30:45+00:00 · 총 42 · done 42 · inflight 0 · untouched 0 · hold 0 · 재오픈 7 · 깊이(done) {'D1': 2, 'D2': 6, 'D3': 3, 'D?': 31}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| PLT-1 | src/core/observability/context.py + tests/platform/unit/test_context.p | done | 461,816,3141 |  |  | 95cd2c6c |
...
| PLT-4 | src/core/observability/metric_names.py, metrics.py + prometheus-client | done | 3136,3335,3455 |  | D3 | 99eeaaf6 |
| PLT-5 | src/api/middleware/request_context.py(타 세션 RequestIdMiddleware 상속), sr | done | 850,3149,3629 |  |  | 98c99ae4 |
| PLT-6 | src/core/event_bus/envelope.py + in_process.py 수정 | done | 2624,2895,3142 |  |  | f60c085e |
| PLT-7 | M1 audit_log_trace_id 마이그레이션 + audit_log.py·record_command_event.py 수정 | done | 906,3156 |  |  | 5f0604ab |
| PLT-8 | loop_health.py + base_loop.py 수정 + main.py 4루프·scheduler 계측(PM) | done | 938,3155 |  |  | 62205370 |
| PLT-9 | src/api/routers/health.py + main.py 등록(PM) | done | 3158,3455,3629 |  | D2 | 98c99ae4 |
| PLT-10 | 도메인 계측 지점 5곳(order_service/submit.py, gate.py, position_ledger.py, rec | done | 2322,2328,3147 |  | D3 | 6a0e995d |
| PLT-11 | config/observability/alert_rules.yaml + docs/runbooks/RB-01..08.md + t | done | 819,3144 |  |  | 479494a5 |
...
| PLT-17 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3174,3179,3181 | 3183 |  | ecc08318 |
| PLT-18 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3174,3179,3181 | 3183 |  | ecc08318 |
| PLT-19 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3174,3179,3181 | 3183 |  | ecc08318 |
| PLT-20 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3174,3179,3181 | 3183 |  | ecc08318 |
| PLT-21 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3174,3179,3181 | 3183 | D2 | ecc08318 |
| PLT-22 | src/services/auth/lockout.py + auth_service.py 수정 + test_lockout_atomi | done | 1021,3148,3300 |  |  | d3f5e419 |
| PLT-23 | M3 auth_session + session_repository.py + tokens.py | done | 1166,1380,3162 |  |  | 22139c50 |
| PLT-24 | auth/login.py, refresh.py, logout.py + routers/auth.py·deps.py 수정 | done | 3184,3310,3398 |  |  | ba5ad7e3 |
| PLT-25 | rate_limit/policy.py, limiter.py, api/middleware/rate_limit.py + main. | done | 1021,3153,3321 |  | D2 | 1dba9de4 |
| PLT-26 | M4 tenant_and_membership(tenant, tenant_membership, backfill personal  | done | 2020,2091,3159 |  |  | 126fa0d7 |
| PLT-27 | ports/membership_repository.py + adapters/postgres_membership_reposito | done | 1076,3168 |  |  | 5d4543fa |
| PLT-28 | application/resolve_tenant_context.py + contracts/v1.py MINOR + founda | done | 2020,2091,3171 |  | D1 | 0c5a9b67 |
| PLT-29 | grant/suspend/revoke_membership.py + trust_memberships.py 라우터 + 적대 테스트 | done | 839,1103,3175 |  |  | 4e74fea4 |
| PLT-30 | src/db/roles.sql + M5 rls_policies(tenant_id 컬럼 테이블 전수) + core/db/tena | done | 1557,2086,3173 |  | D1 | ef707e62 |
...
| PLT-36 | tests/support/db.py + conftest.py·setup_test_db.py 수정 + pytest-xdist | done | 3140,3188,3337 |  |  | 5631cddb |
| PLT-37 | scripts/coverage_ratchet.py + coverage-baseline.txt + CI 스텝 | done | 2176,3154,3182 |  |  | 1e57a855 |
| PLT-38 | scripts/check_migration_chain.py, check_zone_diff.py + CI 스텝 + test_ch | done | 2033,2099,3137 |  |  | a0845df5 |
| PLT-39 | .gitleaks.toml + config/release_gates.yaml + check_release_gate.py | done | 846,3146 |  |  | f727f809 |
| PLT-40 | exchanges/common/http_client.py Protocol + 믹스인 31개 type: ignore 제거(거래소 | done | 1105,2683,3176 | 3161,3163,3166 | D2 | d8125b36 |
