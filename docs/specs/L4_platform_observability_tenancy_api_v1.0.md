...
갱신 2026-09-24T17:13:11+00:00 · 총 42 · done 42 · inflight 0 · untouched 0 · hold 0 · 재오픈 7 · 깊이(done) {'D1': 2, 'D2': 11, 'D3': 3, 'D?': 26}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| PLT-1 | src/core/observability/context.py + tests/platform/unit/test_context.p | done | 816,3141,4126 |  |  | d8b931d1 |
| PLT-2 | src/core/logging/redaction.py, fields.py + 단위 테스트 | done | 3297,3379,3919 | 6770,6772,6773 | D3 | da1f6315 |
| PLT-3 | src/core/logging/schema.py 수정(fields 위임, QueueHandler) | done | 4129,4200,5199 |  |  | ba12a8f1 |
| PLT-4 | src/core/observability/metric_names.py, metrics.py + prometheus-client | done | 3455,4117,4118 |  | D3 | affb1fdb |
| PLT-5 | src/api/middleware/request_context.py(타 세션 RequestIdMiddleware 상속), sr | done | 850,3149,3629 |  |  | 98c99ae4 |
| PLT-6 | src/core/event_bus/envelope.py + in_process.py 수정 | done | 2895,3142,4127 |  |  | 559de04b |
| PLT-7 | M1 audit_log_trace_id 마이그레이션 + audit_log.py·record_command_event.py 수정 | done | 906,3156 |  |  | 5f0604ab |
| PLT-8 | loop_health.py + base_loop.py 수정 + main.py 4루프·scheduler 계측(PM) | done | 938,3155,4455 |  |  | 6b5c6c36 |
| PLT-9 | src/api/routers/health.py + main.py 등록(PM) | done | 3455,3629,4131 |  | D2 | 4b17020c |
| PLT-10 | 도메인 계측 지점 5곳(order_service/submit.py, gate.py, position_ledger.py, rec | done | 2322,2328,3147 |  | D3 | 6a0e995d |
| PLT-11 | config/observability/alert_rules.yaml + docs/runbooks/RB-01..08.md + t | done | 819,3144,4128 |  |  | beec4c08 |
...
| PLT-14 | src/api/contracts/idempotency.py + core/idempotency.py 수정 + M2 idempot | done | 1024,1137,3157 |  |  | 0e0f8cc4 |
| PLT-15 | 금전 라우트 이관 6곳(marketplace purchase, admin confirm-payment, wallet, exec | done | 3185,3186,4905 |  |  | 9d1c0a2a |
| PLT-16 | src/api/versioning.py + scripts/export_openapi.py + contracts/openapi/ | done | 3151,3180,3193 |  | D2 | 4333920b |
| PLT-17 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 5211,6733,6734 | 6737,6738,6813 | D2 |  |
| PLT-18 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 5211,6733,6734 | 6737,6738,6813 | D2 |  |
| PLT-19 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 5211,6733,6734 | 6737,6738,6813 | D2 |  |
| PLT-20 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 5211,6733,6734 | 6737,6738,6813 | D2 |  |
| PLT-21 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 5211,6733,6734 | 6737,6738,6813 | D2 |  |
| PLT-22 | src/services/auth/lockout.py + auth_service.py 수정 + test_lockout_atomi | done | 1021,3148,3300 |  |  | d3f5e419 |
| PLT-23 | M3 auth_session + session_repository.py + tokens.py | done | 1380,3162,4134 |  |  | 97c43cbd |
| PLT-24 | auth/login.py, refresh.py, logout.py + routers/auth.py·deps.py 수정 | done | 3310,3398,6010 |  |  | 9ed1b9f7 |
| PLT-25 | rate_limit/policy.py, limiter.py, api/middleware/rate_limit.py + main. | done | 3153,3321,4130 |  | D2 | 14b60ca5 |
| PLT-26 | M4 tenant_and_membership(tenant, tenant_membership, backfill personal  | done | 2091,3159,4133 |  |  | 126fa0d7 |
| PLT-27 | ports/membership_repository.py + adapters/postgres_membership_reposito | done | 1076,3168 |  |  | 5d4543fa |
| PLT-28 | application/resolve_tenant_context.py + contracts/v1.py MINOR + founda | done | 2091,3171,4135 |  | D1 | 0c5a9b67 |
| PLT-29 | grant/suspend/revoke_membership.py + trust_memberships.py 라우터 + 적대 테스트 | done | 839,1103,3175 |  |  | 4e74fea4 |
| PLT-30 | src/db/roles.sql + M5 rls_policies(tenant_id 컬럼 테이블 전수) + core/db/tena | done | 3173,4136,4137 |  | D1 | b9affaa8 |
| PLT-31 | key_ring.py + encryption.py 포맷 변경 + 단위 테스트 | done | 3138,3150,3338 |  |  | f97ae28e |
| PLT-32 | envelope.py(봉투 암호화), secret_ref.py | done | 932,3152,3904 |  |  | 9088be42 |
| PLT-33 | M6 exchange_credentials_key_version_scope(key_id, scope, UNIQUE 교체) +  | done | 482,1019,3169 |  |  | 4255a436 |
| PLT-34 | scripts/rotate_credential_keys.py + test_key_rotation.py + RB-05 | done | 1544,3177,3187 |  |  | 3c66325b |
| PLT-35 | M7 break_glass_grant + break_glass.py + admin_deps.py 수정(MFA 필수) | done | 2682,3850,6482 |  | D2 | 176caa0d |
| PLT-36 | tests/support/db.py + conftest.py·setup_test_db.py 수정 + pytest-xdist | done | 3337,4120,6005 |  |  | 817a43a1 |
| PLT-37 | scripts/coverage_ratchet.py + coverage-baseline.txt + CI 스텝 | done | 3154,3182,6007 |  |  | 823cc8c3 |
| PLT-38 | scripts/check_migration_chain.py, check_zone_diff.py + CI 스텝 + test_ch | done | 2099,3137,4119 |  |  | 02b109c3 |
| PLT-39 | .gitleaks.toml + config/release_gates.yaml + check_release_gate.py | done | 846,3146,6006 | 6717,6718,6720 |  | 491a77b3 |
| PLT-40 | exchanges/common/http_client.py Protocol + 믹스인 31개 type: ignore 제거(거래소 | done | 3163,3166,3176 |  | D2 | 174517f7 |
| PLT-41 | pyproject.toml ruff 규칙군 확장(S,BLE,ARG,PGH,T20) + 위반 정리 | done | 1092,1923,3172 |  |  | 5f27b597 |
| PLT-42 | docs/TESTING.md·README 갱신, .env.example에 JWT_SIGNING_KEYS, CREDENTIAL_ | done | 2684 |  | D2 | ba1140a1 |
<!-- spec-status:end -->
