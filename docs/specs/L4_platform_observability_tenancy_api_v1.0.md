...
갱신 2026-09-23T17:02:31+00:00 · 총 42 · done 42 · inflight 0 · untouched 0 · hold 0 · 재오픈 3 · 깊이(done) {'D1': 2, 'D2': 11, 'D3': 3, 'D?': 26}
...
| PLT-17 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3183,5210,5211 |  | D2 |  |
| PLT-18 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3183,5210,5211 |  | D2 |  |
| PLT-19 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3183,5210,5211 |  | D2 |  |
| PLT-20 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3183,5210,5211 |  | D2 |  |
| PLT-21 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3183,5210,5211 |  | D2 |  |
...
| PLT-36 | tests/support/db.py + conftest.py·setup_test_db.py 수정 + pytest-xdist | done | 3188,3337,4120 | 6005 |  | eb08dd20 |
| PLT-37 | scripts/coverage_ratchet.py + coverage-baseline.txt + CI 스텝 | done | 2176,3154,3182 | 6007 |  | 1e57a855 |
| PLT-38 | scripts/check_migration_chain.py, check_zone_diff.py + CI 스텝 + test_ch | done | 2099,3137,4119 |  |  | 02b109c3 |
| PLT-39 | .gitleaks.toml + config/release_gates.yaml + check_release_gate.py | done | 846,3146 | 6006 |  | f727f809 |
