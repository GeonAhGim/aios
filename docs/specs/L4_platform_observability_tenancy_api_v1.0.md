...
갱신 2026-09-15T10:18:54+00:00 · 총 42 · done 40 · inflight 2 · untouched 0 · hold 0 · 재오픈 38 · 깊이(done) {'D1': 2, 'D2': 1, 'D3': 3, 'D?': 34}

| ID | 리프 | 상태 | done task | 열린 task | depth | commit |
|---|---|---|---|---|---|---|
| PLT-1 | src/core/observability/context.py + tests/platform/unit/test_context.p | done | 461,816 | 3141 |  | 77bfdb4 |
| PLT-2 | src/core/logging/redaction.py, fields.py + 단위 테스트 | done | 2328,3297,3379 | 3143 | D3 | ff4b86e8 |
| PLT-3 | src/core/logging/schema.py 수정(fields 위임, QueueHandler) | done | 845 | 3145 |  | e8cb56e |
| PLT-4 | src/core/observability/metric_names.py, metrics.py + prometheus-client | done | 2328,3335,3455 | 3136 | D3 | 2e0488f |
| PLT-5 | src/api/middleware/request_context.py(타 세션 RequestIdMiddleware 상속), sr | done | 217,850 | 3149,3629 |  | 40f8586 |
| PLT-6 | src/core/event_bus/envelope.py + in_process.py 수정 | done | 818,2330,2895 | 2624,3142 |  | 9c4591e7 |
| PLT-7 | M1 audit_log_trace_id 마이그레이션 + audit_log.py·record_command_event.py 수정 | done | 906 | 3156 |  | fa553a5 |
| PLT-8 | loop_health.py + base_loop.py 수정 + main.py 4루프·scheduler 계측(PM) | done | 938 | 3155 |  | fcd2d16 |
| PLT-9 | src/api/routers/health.py + main.py 등록(PM) | done | 494,939,3455 | 3158,3629 |  | 2e0488f |
| PLT-10 | 도메인 계측 지점 5곳(order_service/submit.py, gate.py, position_ledger.py, rec | done | 851,2322,2328 | 3147 | D3 | 09a985e6 |
| PLT-11 | config/observability/alert_rules.yaml + docs/runbooks/RB-01..08.md + t | done | 819 | 3144 |  | d2102c1 |
| PLT-12 | src/api/contracts/error_codes.py, envelope.py, pagination.py + 단위 테스트 | done | 152,323 |  |  | ca93f25 |
| PLT-13 | src/api/contracts/exception_mapping.py, handlers.py + main.py 설치(PM) | done | 322 |  |  | 65c29b1 |
| PLT-14 | src/api/contracts/idempotency.py + core/idempotency.py 수정 + M2 idempot | done | 940,1024,1137 | 3157 |  | 8635c90 |
| PLT-15 | 금전 라우트 이관 6곳(marketplace purchase, admin confirm-payment, wallet, exec | done | 1333,3185,3186 | 3135,3139 |  | d788d1e |
| PLT-16 | src/api/versioning.py + scripts/export_openapi.py + contracts/openapi/ | done | 1216,1325,1956 | 3151,3180,3193 |  | 4333920b |
| PLT-17 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 1160,1217,1218 | 3179,3181,3183 |  | b681258 |
| PLT-18 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 1160,1217,1218 | 3179,3181,3183 |  | b681258 |
| PLT-19 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 1160,1217,1218 | 3179,3181,3183 |  | b681258 |
| PLT-20 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 1160,1217,1218 | 3179,3181,3183 |  | b681258 |
| PLT-21 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 1217,1218,1619 | 3179,3181,3183 | D2 | 9ccb238 |
| PLT-22 | src/services/auth/lockout.py + auth_service.py 수정 + test_lockout_atomi | done | 852,1021,3300 | 3148 |  | 065bdab7 |
| PLT-23 | M3 auth_session + session_repository.py + tokens.py | done | 1020,1166,1380 | 3162 |  | 68568b3 |
| PLT-24 | auth/login.py, refresh.py, logout.py + routers/auth.py·deps.py 수정 | done | 1324,3310,3398 | 3170,3184 |  | c6242a80 |
| PLT-25 | rate_limit/policy.py, limiter.py, api/middleware/rate_limit.py + main. | done | 853,1021,3321 | 3153 |  | 7e37a077 |
| PLT-26 | M4 tenant_and_membership(tenant, tenant_membership, backfill personal  | done | 1010,2020,2091 | 3159 |  | fb3ad3d0 |
| PLT-27 | ports/membership_repository.py + adapters/postgres_membership_reposito | done | 1076 | 3168 |  | 109514b |
| PLT-28 | application/resolve_tenant_context.py + contracts/v1.py MINOR + founda | done | 1557,2020,2091 | 3171 | D1 | fb3ad3d0 |
| PLT-29 | grant/suspend/revoke_membership.py + trust_memberships.py 라우터 + 적대 테스트 | done | 617,839,1103 | 3175 |  | 85789df |
| PLT-30 | src/db/roles.sql + M5 rls_policies(tenant_id 컬럼 테이블 전수) + core/db/tena | done | 1189,1557,2086 | 3173 | D1 | 8d06215e |
| PLT-31 | key_ring.py + encryption.py 포맷 변경 + 단위 테스트 | done | 473,904,3338 | 3138,3150 |  | 401c16dd |
| PLT-32 | envelope.py(봉투 암호화), secret_ref.py, secret_handle.py | done | 932 | 3152 |  | 7546c50 |
| PLT-33 | M6 exchange_credentials_key_version_scope(key_id, scope, UNIQUE 교체) +  | done | 482,1019 | 3169 |  | dace2f7 |
| PLT-34 | scripts/rotate_credential_keys.py + test_key_rotation.py + RB-05 | done | 1104,1544 | 3177,3187 |  | 6db8ce8 |
| PLT-35 | M7 break_glass_grant + break_glass.py + admin_deps.py 수정(MFA 필수) | inflight |  | 2682 |  |  |
| PLT-36 | tests/support/db.py + conftest.py·setup_test_db.py 수정 + pytest-xdist | done | 1137,1615,3337 | 3140,3188 |  | 5919acd |
| PLT-37 | scripts/coverage_ratchet.py + coverage-baseline.txt + CI 스텝 | done | 933,1240,2176 | 3154,3182 |  | b2ab90fb |
| PLT-38 | scripts/check_migration_chain.py, check_zone_diff.py + CI 스텝 + test_ch | done | 459,2033,2099 | 3137 |  | a3096b99 |
| PLT-39 | .gitleaks.toml + config/release_gates.yaml + check_release_gate.py | done | 846 | 3146 |  | 0b0fc3c |
| PLT-40 | exchanges/common/http_client.py Protocol + 믹스인 31개 type: ignore 제거(거래소 | done | 1011,1032,1105 | 3163,3166,3176 |  | cda979f |
| PLT-41 | pyproject.toml ruff 규칙군 확장(S,BLE,ARG,PGH,T20) + 위반 정리 | done | 1092,1923 | 3172 |  | a7b7951 |
| PLT-42 | docs/TESTING.md·README 갱신, .env.example에 JWT_SIGNING_KEYS, CREDENTIAL_ | inflight |  | 2684 |  |  |
<!-- spec-status:end -->
