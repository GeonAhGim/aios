...
갱신 2026-09-22T17:04:05+00:00 · 총 42 · done 42 · inflight 0 · untouched 0 · hold 0 · 재오픈 6 · 깊이(done) {'D1': 2, 'D2': 11, 'D3': 3, 'D?': 26}
...
| PLT-2 | src/core/logging/redaction.py, fields.py + 단위 테스트 | done | 3297,3379,3919 |  | D3 | da1f6315 |
| PLT-3 | src/core/logging/schema.py 수정(fields 위임, QueueHandler) | done | 3145,4129,4200 | 5199 |  | a1d7b71 |
...
| PLT-17 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 | 5210,5211 | D2 | dd3b0262 |
| PLT-18 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 | 5210,5211 | D2 | dd3b0262 |
| PLT-19 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 | 5210,5211 | D2 | dd3b0262 |
| PLT-20 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 | 5210,5211 | D2 | dd3b0262 |
| PLT-21 | 레거시 라우터 15개 봉투·예외 이관(3개씩 5리프: auth/users/exchange_credentials → market | done | 3179,3181,3183 | 5210,5211 | D2 | dd3b0262 |
...
| PLT-24 | auth/login.py, refresh.py, logout.py + routers/auth.py·deps.py 수정 | done | 3184,3310,3398 |  |  | ba5ad7e3 |
...
| PLT-35 | M7 break_glass_grant + break_glass.py + admin_deps.py 수정(MFA 필수) | done | 2682,3850 |  | D2 | 173c4e96 |
| PLT-36 | tests/support/db.py + conftest.py·setup_test_db.py 수정 + pytest-xdist | done | 3188,3337,4120 |  |  | eb08dd20 |
| PLT-37 | scripts/coverage_ratchet.py + coverage-baseline.txt + CI 스텝 | done | 2176,3154,3182 |  |  | 1e57a855 |
| PLT-38 | scripts/check_migration_chain.py, check_zone_diff.py + CI 스텝 + test_ch | done | 2099,3137,4119 |  |  | 02b109c3 |
| PLT-39 | .gitleaks.toml + config/release_gates.yaml + check_release_gate.py | done | 846,3146 |  |  | f727f809 |
