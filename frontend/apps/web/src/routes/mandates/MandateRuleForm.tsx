  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        <Field label={t("legacy.mandateRuleForm.label1")}>
          <Input
            type="number"
        ...
        <Field label={t("legacy.mandateRuleForm.label2")}>
          <Input
            type="number"
        ...
        <Field label={t("legacy.mandateRuleForm.label3")}>
          <Input
            type="number"
        ...
        <Field label={t("legacy.mandateRuleForm.label4")}>
          <Input
            type="number"
        ...
        <Field label={t("legacy.mandateRuleForm.label5")}>
          <Select
        ...
        <Field label={t("legacy.mandateRuleForm.label6")}>
          <Input
            type="text"
