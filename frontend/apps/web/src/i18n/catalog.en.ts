...
export const catalogEn = {
  ...
  nav: {
    ...
    "/compliance/mandate": "Mandate editing & approval",
  ...
  executionAlgoPage: {
    pageTitle: "Algo execution progress",
    missingOrderId: "No order ID.",
    notFoundDescription: "This algo order does not exist.",
    unavailable: "Unable to load data.",
    cardTitle: "Execution progress",
    totalSlices: "Total slices",
    submittedSlices: "Submitted",
    pendingSlices: "Pending",
    status: "Status",
    remainingQty: "Remaining quantity",
    demotedToTwap: "Demoted to TWAP",
    refresh: "Refresh",
  },
  tcaPage: {
    pageTitle: "Transaction cost analysis (TCA)",
    missingOrderId: "No order ID.",
    notComputedYet: "TCA data has not been computed yet.",
    startCompute: "Start TCA computation",
    noData: "No TCA data.",
    resultTitle: "TCA analysis result",
  ...
  performanceStatementsPage: {
    ...
    computeTitle: "Compute statement",
    scope: "Scope",
    scopeAll: "All",
    periodStart: "Period start",
    periodEnd: "Period end",
    methodologyVersion: "Methodology version",
    methodologyVersionPlaceholder: "e.g. v1.0 (defaults if empty)",
    computeSubmit: "Request compute",
    listTitle: "Statements",
    portfolioId: "Portfolio ID",
    portfolioIdPlaceholder: "Optional",
    listEmpty: "No performance statements.",
    asOf: "As of: {{asOf}}",
    component: "Component",
    amount: "Amount",
    grossPnl: "Gross P&L",
    ...
    funding: "Funding",
    fx: "FX",
    cashflowsNet: "Net cashflows",
    estimatedTax: "Estimated tax",
    netPnl: "Net P&L",
    returns: "Returns",
    annualized: "annualized",
    estimated: "Estimated",
    identityMismatch: "Component totals do not match net P&L (residual: {{residual}}).",
    correctReasonLabel: "Correction reason",
    correctReasonPlaceholder: "Enter a correction reason",
    correctSubmit: "Request correction",
    correctSuccess: "Correction request applied.",
    notFoundTitle: "Statement not found",
    notFoundDescription: "This performance statement does not exist.",
  },
  mandatePage: {
    pageTitle: "Mandate editing & approval",
    listTitle: "Mandate list",
    listEmpty: "No mandates registered.",
    activeLabel: "Active",
