...
export const catalogKo = {
  ...
  nav: {
    "nav./dashboard": "대시보드",
    "nav./exchanges": "거래소",
    "nav./market/instruments": "종목",
    "nav./market/candles": "캔들",
    "nav./chart": "차트",
    "nav./screener": "스크리너",
    "nav./backtest/sweep-results": "스윕 결과",
    "nav./strategy-builder": "전략편집기",
    "nav./scripts/editor": "스크립트편집기",
    "nav./marketplace": "마켓플레이스",
    "nav./follow": "팔로우",
    "nav./ai/studio": "AI 스튜디오",
    "nav./executions": "실행제어판",
    "nav./portfolio": "포트폴리오",
    "nav./rebalance": "리밸런싱",
    "nav./mandates": "위임장",
    ...
    "nav./reports": "보고서",
    "nav./wallet": "지갑",
    "nav./wallet/ledger": "지갑거래내역",
    "nav./wallet/payouts": "출금",
    "nav./alerts": "알림",
    "nav./notifications": "알림센터",
    "nav./system/paper-deployments": "페이퍼배포",
    "nav./approval-requests": "승인대기",
    "nav./settings/approval": "승인설정",
    "nav./settings/notifications": "알림설정",
    "nav./settings/sessions": "세션관리",
    "nav./settings/members": "멤버관리",
    "nav./settings/account": "계정삭제",
    "nav./settings/connections": "계정연동",
    "nav./admin": "관리자",
    "nav./admin/system-status": "시스템상태",
    "nav./admin/verification-queue": "인증대기열",
    "nav./admin/disputes": "분쟁관리",
    "nav./admin/users": "사용자관리",
    "nav./admin/wallet-topups": "충전승인",
    "nav./admin/marketplace/platform-listings": "플랫폼목록",
    "nav./admin/approval-requests": "승인요청관리",
    "nav./admin/safety-controls": "안전통제",
    "nav./admin/reconciliation": "대사관리",
    "nav./admin/evidence-chain": "증빙체인검증",
    "nav./admin/trust": "신뢰멤버십",
  },
