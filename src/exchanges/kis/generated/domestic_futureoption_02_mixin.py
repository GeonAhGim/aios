"""BR-12 자동 생성(ADR-2026-09-06-I D7) -- domestic_futureoption 미착수 TR 청크 02.
...
class KISGeneratedDomesticFutureoption02Mixin(_KISWsHost):
    ...
    async def commodity_futures_realtime_quote_h0cfasp0(
        ...
        *,
        ...
        [국내선물옵션] 실시간시세 > 상품선물 실시간호가[실시간-023] -- WS tr_id=H0CFASP0. 필수
        파라미터: tr_key. 응답 필드: futs_shrn_iscd, bsop_hour, futs_askp1, futs_askp2,
    ...
    async def commodity_futures_realtime_conclusion_h0cfcnt0(
        ...
        *,
        ...
        """BR-12 생성(ADR-2026-09-06-I D7). 미검증: 실계좌 왕복 미확인.
        [국내선물옵션] 실시간시세 > 상품선물 실시간체결가[실시간-022] -- WS tr_id=H0CFCNT0. 필수
    ...
    async def krx_ngt_option_exp_ccnl_h0euanc0(
        ...
        *,
        ...
        """BR-12 생성(ADR-2026-09-06-I D7). 미검증: 실계좌 왕복 미확인.
        [국내선물옵션] 실시간시세 > KRX야간옵션실시간예상체결 [실시간-034] -- WS tr_id=H0EUANC0.
    ...
    async def krx_ngt_option_asking_price_h0euasp0(
        ...
        *,
        ...
        """BR-12 생성(ADR-2026-09-06-I D7). 미검증: 실계좌 왕복 미확인.
        [국내선물옵션] 실시간시세 > KRX야간옵션 실시간호가 [실시간-033] -- WS tr_id=H0EUASP0.
        필수 파라미터: tr_key. 응답 필드: optn_shrn_iscd, bsop_hour, optn_askp1, optn_askp2,
    ...
    async def krx_ngt_option_notice_h0eucni0(
        ...
        *,
        ...
        """BR-12 생성(ADR-2026-09-06-I D7). 미검증: 실계좌 왕복 미확인.
        [국내선물옵션] 실시간시세 > KRX야간옵션실시간체결통보 [실시간-067] -- WS tr_id=H0EUCNI0.
    ...
    async def krx_ngt_option_ccnl_h0eucnt0(
        ...
        *,
        ...
        """BR-12 생성(ADR-2026-09-06-I D7). 미검증: 실계좌 왕복 미확인.
        [국내선물옵션] 실시간시세 > KRX야간옵션 실시간체결가 [실시간-032] -- WS tr_id=H0EUCNT0.
    ...
    async def index_futures_realtime_quote_h0ifasp0(
        ...
        *,
        ...
        """BR-12 생성(ADR-2026-09-06-I D7). 미검증: 실계좌 왕복 미확인.
        [국내선물옵션] 실시간시세 > 지수선물 실시간호가[실시간-011] -- WS tr_id=H0IFASP0. 필수
        파라미터: tr_key. 응답 필드: futs_shrn_iscd, bsop_hour, futs_askp1, futs_askp2,
        futs_askp3, futs_askp4, futs_askp5, futs_bidp1, futs_bidp2, futs_bidp3, futs_bidp4,
        futs_bidp5, askp_csnu1, askp_csnu2, askp_csnu3, askp_csnu4, askp_csnu5, bidp_csnu1,
        bidp_csnu2, bidp_csnu3, bidp_csnu4, bidp_csnu5, askp_rsqn1, askp_rsqn2, askp_rsqn3,
