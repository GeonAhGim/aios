...
class BitgetEarnMixin:
    ...
    async def get_earn_assets(self: SignedRequestClient) -> list[dict[str, Any]]:
        raw = await self._request("GET", "/api/v2/earn/savings/assets")
        return list(raw["data"])
