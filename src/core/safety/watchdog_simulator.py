"""9.7/L4-31 — Watchdog false-positive verification simulator.

Spec: policy doc 8.6-A-1-1, 06_mvp_scope_v1.3.md#§6.3 Definition of Done,
10_implementation_task_tree_v1.9.md 9.7/9.8. Ownership/implementation
responsibility remains specified by
`docs/specs/L4_risk_and_safety_v1.0.md` (`watchdog.py` integration) — this
file had no per-file row in any spec, so no owner or size cap existed;
`docs/specs/L4_execution_oms_and_exchange_v1.0.md` §2-H/§9 L4-31
retroactively registered a row (300-line cap) for it (ADR-2026-09-06-G §10
"graph/document consistency").
