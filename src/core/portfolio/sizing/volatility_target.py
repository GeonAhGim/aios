...
`weight = target_vol_pct / realized_vol_pct` (capped at 100%). If `realized_vol_pct`
is None, reject with `PORTFOLIO_SIZING_INPUT_MISSING` instead of replacing with 0
(negative case as per spec).
"""
