"""Charting unit test suite package marker.

DEEPEN(task-7969), origin leaf task-6704 ("고아 산출물 회수"). This file has
no domain logic -- it is only the package marker that lets pytest treat
`tests/foundation/unit/charting/**` as a package tree. The one real
